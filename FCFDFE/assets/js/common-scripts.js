...
// custom scrollbar
    ...
    $(".sidebar").niceScroll({ styler: "fb", cursorcolor: "#2a3542", cursorwidth: '15', cursorborderradius: '10px', opacity: '1', background: '#F5F5F5', cursorborder: '' });

    $("html").niceScroll({ styler: "fb", cursorcolor: "#2a3542", cursorwidth: '15', cursorborderradius: '10px', background: '#F5F5F5', cursorborder: '', zindex: '' });
