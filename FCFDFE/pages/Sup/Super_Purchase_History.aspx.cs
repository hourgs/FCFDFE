...
{
    public partial class Super_Purchase_History : System.Web.UI.Page
    {
        ...
        ICollection CreateDataSource()
        {
            ...
            foreach (var aa in querySys)
            {
                ...
                dr[15] = "Super_Purchase_History_1.aspx?OVC_PURCH=" + ovcpurchkey;
                if (ovcpurch == "NODATA")
                    dr[16] = "";
                else
                    dr[16] = "Super_Purchase_History_2.aspx?OVC_VEN_CST=" + ovcvencst;
                dr[17] = "Super_Purchase_History_3.aspx?OVC_PURCH=" + ovcpurchkey + "&OVC_PURCH_6=" + ovcpurch6key;
                dr[18] = "Super_Purchase_History_4.aspx?OVC_PURCH=" + ovcpurchkey + "&ONB_POI_ICOUNT=" + onbpoiicountkey;
                dr[19] = "0%";//報價折幅
                dr[20] = "0%";//標價折幅
                dt.Rows.Add(dr);
                i++;
