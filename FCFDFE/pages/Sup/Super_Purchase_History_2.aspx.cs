...
{
    public partial class Super_Purchase_History_2 : System.Web.UI.Page
    {
        ...
        protected void GVTBGMT_1302_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            switch (e.CommandName)
            {
                case "btnPurch6":
                    ...
                    str_url_Modify = "Super_Purchase_History_3.aspx?OVC_PURCH=" + key + "&OVC_PURCH_6=" + key6;
                    Response.Redirect(str_url_Modify);
                    break;
                case "btnPurch":
                    string str_url_Modify1;
                    str_url_Modify1 = "Super_Purchase_History_1.aspx?OVC_PURCH=" + key;
