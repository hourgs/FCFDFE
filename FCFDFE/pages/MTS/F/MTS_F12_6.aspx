<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MTS_F12_6.aspx.cs" Inherits="FCFDFE.pages.MTS.F.MTS_F12_6" %>
                            ...
                            <table class="table table-bordered">
                                <tr>
                                    <td style="width:200px;" class="text-center">
                                        <asp:Label ID="lblOVC_COMPANY" CssClass="control-label" runat="server">廠商名稱</asp:Label>
                                    </td>
