<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MTS_F13_2.aspx.cs" Inherits="FCFDFE.pages.MTS.F.MTS_F13_2" %>
                            ...
                            <table class="table table-bordered">
                                <tr>
                                    ...
                                    <td style="width:800px;" colspan="3">
                                        <asp:DropDownList ID="drpOVC_INSCOMPNAY" CssClass="tb tb-s" runat="server"></asp:DropDownList>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="width:200px;" class="text-center">
                                ...
                                <tr>
                                    ...
                                    <td style="width:800px;" colspan="3">
                                       <asp:Label ID="lblOdtCreateDate" CssClass="control-label text-blue" runat="server" Text="lblOdtCreateDate"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="width:200px;" class="text-center">
                                    ...
                                    <td style="width:800px;" colspan="3">
                                        <asp:Label ID="lblOvcCreateId" CssClass="control-label text-blue" runat="server" Text="lblOvcCreateId"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="width:200px;" class="text-center">
                                    ...
                                    <td style="width:800px;" colspan="3">
                                       <asp:Label ID="lblOdtModifyDate" CssClass="control-label text-blue" runat="server" Text="lblOdtModifyDate"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="width:200px;" class="text-center">
                                        <asp:Label CssClass="control-label" runat="server">資料修改人員</asp:Label>
                                    </td>
                                    <td style="width:800px;" colspan="3">
                                       <asp:Label ID="lblModifyLoginId" CssClass="control-label text-blue" runat="server" Text="lblModifyLoginId"></asp:Label>
                                    </td>
                                </tr>
                            </table>
                            <div style="text-align:center;">
                                <asp:Button ID="btnSave" cssclass="btn-warning" runat="server" Text="更新保險費率資料" OnClick="btnSave_Click" /> 
                                <asp:Button ID="btnDel" cssclass="btn-danger" runat="server" OnClientClick="if (confirm('確定刪除此資料?') == false) return false;" Text="刪除保險費率資料" OnClick="btnDel_Click" /><br /><br />
