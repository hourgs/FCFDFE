<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MTS_F17.aspx.cs" Inherits="FCFDFE.pages.MTS.F.MTS_F17" %>
                    ...
                    <div class="form" style="border: 5px;">
                        <div class="cmxform form-horizontal tasi-form">
                                ...
                                <tr>
                                    ...
                                    <td style="width: 800px;" colspan="3">
                                        <asp:DropDownList ID="drpOvcClass" CssClass="tb tb-s  position-left" runat="server">
                                            <asp:ListItem Selected>全部</asp:ListItem>
                                        </asp:DropDownList>
                                    </td>
                                </tr>
                            </table>
                            <div style="text-align: center;">
                                ...
                                <br />
                                <br />
                                <asp:Button ID="btnSave" CssClass="btn-success" runat="server" Text="新增接轉單位種類" OnClick="btnSave_Click" />
                                <br />
                            </div>
                            <asp:GridView ID="GV_TBGMT_DEPT_CLASS" DataKeyNames="OVC_DEPTCLA_SN" CssClass="table data-table table-striped border-top" AutoGenerateColumns="false" OnPreRender="GV_TBGMT_DEPT_CLASS_PreRender" OnRowCommand="GV_TBGMT_DEPT_CLASS_RowCommand" runat="server" RowStyle-HorizontalAlign="Center" >
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="">
                                        <ItemTemplate>
                                            <asp:Button ID="btnDel" CssClass="btn-danger btnw2" Text="刪除" CommandName="DataDelete" runat="server" />
                                        </ItemTemplate>
                                        <EditItemTemplate>
                                            <asp:Button ID="btncancel" CssClass="btn-success btnw2" Text="取消" CommandName="DataCancel" runat="server" OnClientClick="if (confirm('確定刪除?') == false) return false;"/>
                                        </EditItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                            </asp:GridView>
