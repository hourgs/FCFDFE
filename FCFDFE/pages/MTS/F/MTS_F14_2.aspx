<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MTS_F14_2.aspx.cs" Inherits="FCFDFE.pages.MTS.F.MTS_F14_2" %>
                    ...
                    <div class="form" style="border: 5px;">
                        <div class="cmxform form-horizontal tasi-form">
                            <table class="table table-bordered">
                                <tr>
                                    ...
                                    <td style="width:800px;" colspan="3">
                                       <asp:Label ID="lblPortCdeSn" CssClass="control-label" runat="server" Text=""></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="width:200px;" class="text-center">
                            ...
                            <div style="text-align:center;">
                                <asp:Button ID="btnSave" cssclass="btn-warning" runat="server" Text="更新機場港口資料"  OnClick="btnSave_Click" OnClientClick="if (confirm('確定更新?') == false) return false;"/> 
                                <asp:Button ID="btnDel" cssclass="btn-danger" runat="server" Text="刪除機場港口資料"  OnClick="btnDel_Click" OnClientClick="if (confirm('確定刪除?') == false) return false;"/><br /><br />
