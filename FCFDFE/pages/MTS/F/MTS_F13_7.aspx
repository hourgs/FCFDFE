<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MTS_F13_7.aspx.cs" Inherits="FCFDFE.pages.MTS.F.MTS_F13_7" %>
                    ...
                    <div class="form" style="border: 5px;">
                        <div class="cmxform form-horizontal tasi-form">
                                        ...
                                        <table>
                                            ...
                                            <tr>
                                                <td colspan="6">
                                                    ...
                                                    <asp:TextBox ID="txtONB_EUR_BLD_QUANTITY_1" CssClass="tb tb-xs" runat="server"></asp:TextBox>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                    <asp:Label CssClass="control-label" runat="server">X&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;危險品收費</asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                    <asp:TextBox ID="txtONB_EUR_DANGER_PRO_COST_1" CssClass="tb tb-xs" runat="server"></asp:TextBox>
                                            ...
                                            <tr>
                                                <td colspan="6">
                                                    ...
                                                    <asp:TextBox ID="txtONB_USA_BLD_QUANTITY_1" CssClass="tb tb-xs" runat="server"></asp:TextBox>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                    <asp:Label CssClass="control-label" runat="server">X&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;危險品收費</asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                    <asp:TextBox ID="txtONB_USA_DANGER_PRO_COST_1" CssClass="tb tb-xs" runat="server"></asp:TextBox>
                                                    <asp:Label CssClass="control-label" runat="server">%&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;=</asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    ...
                                    <td colspan="4">
                                        <table>
                                            ...
                                            <tr>
                                                <td colspan="6">
                                                    <asp:Label CssClass="control-label text-center" runat="server">歐洲線危險品收費：提單</asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                    <asp:TextBox ID="txtONB_EUR_BLD_QUANTITY_2" CssClass="tb tb-xs" runat="server"></asp:TextBox>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                    <asp:Label CssClass="control-label" runat="server">X&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;危險品收費</asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                    <asp:TextBox ID="txtONB_EUR_DANGER_PRO_COST_2" CssClass="tb tb-xs" runat="server"></asp:TextBox>
                                                    <asp:Label CssClass="control-label" runat="server">%&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;=</asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            ...
                                            <tr>
                                                <td colspan="6">
                                                    <asp:Label CssClass="control-label text-center" runat="server">美國線危險品收費：提單</asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                    <asp:TextBox ID="txtONB_USA_BLD_QUANTITY_2" CssClass="tb tb-xs" runat="server"></asp:TextBox>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                    <asp:Label CssClass="control-label" runat="server">X&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;危險品收費</asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                    <asp:TextBox ID="txtONB_USA_DANGER_PRO_COST_2" CssClass="tb tb-xs" runat="server"></asp:TextBox>
                                                    <asp:Label CssClass="control-label" runat="server">%&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;=</asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            ...
                            <div style="text-align:center;">
                                <asp:Button ID="btnSave" cssclass="btn-warning" runat="server" OnClick="btnSave_Click" Text="更新空運運費資料" />
                                &nbsp;&nbsp;&nbsp;&nbsp;
                                <asp:Button ID="btnDel" cssclass="btn-danger" runat="server" OnClick="btnDel_Click"  OnClientClick="if (confirm('確定刪除?') == false) return false;" Text="刪除空運運費資料" /><br /><br />
