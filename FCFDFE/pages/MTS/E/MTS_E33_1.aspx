<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MTS_E33_1.aspx.cs" Inherits="FCFDFE.pages.MTS.E.MTS_E33_1" %>
                    ...
                    <div class="form" style="border: 5px;">
                        <div class="cmxform form-horizontal tasi-form">
                            <table class="table table-bordered">
                                <tr>
                                    <td style="width: 200px;" class="text-center">
                                        <asp:Label CssClass="control-label" runat="server">接轉組別</asp:Label>
                                    </td>
                                    <td style="width: 800px;" colspan="3">
                                        <asp:DropDownList ID="drpOvcSection" CssClass="tb tb-m  position-left" runat="server">
                                ...
                                <tr>
                                    ...
                                    <td style="width: 300px;">
                                        <asp:DropDownList ID="drpOvcIsPaid" CssClass="tb tb-m  position-left" runat="server">
                                            <asp:ListItem>不限定</asp:ListItem>
                            ...
                            <div style="text-align: center;">
                                <asp:Button ID="btnQuery" OnClick="btnQuery_Click" CssClass="btn-success" runat="server" Text="查詢" /><br />
                                <br />
                            </div>
                            <asp:GridView ID="GV_TBGMT_TOF" DataKeyNames="OVC_TOF_NO" OnRowCommand="GV_TBGMT_TOF_RowCommand" CssClass="table data-table table-striped border-top" AutoGenerateColumns="false" OnPreRender="GV_TBGMT_TOF_PreRender" runat="server">
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="ODT_PAID_DATE" HeaderText="付款日期" DataFormatString="{0:d}" />
                                    <asp:TemplateField HeaderText="">
                                        <ItemTemplate>
                                            <asp:Button ID="btnModify" CssClass="btn-success" Text="修改" CommandName="btnModify" runat="server" /> 
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                            </asp:GridView>
