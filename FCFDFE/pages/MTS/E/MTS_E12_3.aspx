<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MTS_E12_3.aspx.cs" Inherits="FCFDFE.pages.MTS.E.MTS_E12_3" %>
    ...
    <div class="row">
        <div style="width: 1000px; margin:auto;">
            <section class="panel">
                ...
                <asp:Panel ID="msg" runat="server"></asp:Panel><!--預留空間，未來做錯誤訊息顯示。-->
                    ...
                    <div class="form" style="border: 5px;">
                        <div class="cmxform form-horizontal tasi-form">
                            ...
                            <div style="text-align:center;">
                                <asp:Button ID="btnSave" cssclass="btn-warning btnw6" OnClick="btnSave_Click" runat="server" Text="新增運費資料" /><br /><br />
                                <asp:Button ID="btnHome" cssclass="btn-success btnw4" OnClick="btnHome_Click" runat="server" Text="回主頁" /><br />
                            </div>
                        </div>
                    </div>
                </div>
