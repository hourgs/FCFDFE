<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MTS_E12_2.aspx.cs" Inherits="FCFDFE.pages.MTS.E.MTS_E12_2" %>
                    ...
                    <div class="form" style="border: 5px;">
                        <div class="cmxform form-horizontal tasi-form">
                            <table class="table table-bordered">
                                <tr>
                                    <td colspan="3" style="text-align:center;vertical-align:middle;">
                                        <asp:Button ID="btnlast" cssclass="btn-success btnw4" OnClick="btnlast_Click" runat="server" Text="上一筆" />&nbsp;&nbsp;
                            ...
                            <div style="text-align:center;">
                                <asp:Button ID="btnSave" cssclass="btn-warning btnw6" OnClick="btnSave_Click" runat="server" Text="更新運費資料" />
                                <asp:Button ID="btnDel" cssclass="btn-danger btnw6" OnClick="btnDel_Click" runat="server" Text="刪除運費資料" /><br /><br />
                                <asp:Button ID="btnHome" cssclass="btn-success btnw4" OnClick="btnHome_Click" runat="server" Text="回主頁" />
                            </div>
                        </div>
                    </div>
                </div>
