<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MTS_C15_2.aspx.cs" Inherits="FCFDFE.pages.MTS.C.MTS_C15_2" %>
        ...
        <div style="width: 1000px; margin:auto;">
            <section class="panel">
                            ...
                            <table class="table table-bordered">
                                <tr>
                                    ...
                                    <td colspan="3">
                                        ...
                                        <asp:Label ID="lblOVC_CREATE_ID" CssClass="control-label" runat="server"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <asp:Button CssClass="btn-success btnw2" OnClientClick="OpenWindow('txtOVC_DEPT_CDE', 'txtOVC_ONNAME')" Text="單位" runat="server" />&nbsp;&nbsp;
                                ...
                                <tr>
                                    <td class="text-center">
                                        <asp:Label CssClass="control-label" runat="server">國防採購室申請保留索賠權來文文號</asp:Label>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtOVC_PURCHASE_MSG_NO" CssClass="tb tb-l" OnTextChanged="txtOVC_NO_TextChanged" AutoPostBack="true" runat="server"></asp:TextBox>
                                    </td>
                                    <td  class="text-center">
                                        <asp:Label CssClass="control-label" runat="server">國防採購室申請保留索賠權來文日期</asp:Label>
                                    </td>
                                    <td>
                                        <div class="input-append datepicker">
                                            <asp:TextBox ID="txtOVC_PURCHASE_DATE" CssClass="tb tb-date" runat="server"></asp:TextBox>
                                            <span class='add-on'><i class="icon-calendar"></i></span>
                                        </div>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td class="text-center">
                                       <asp:Label CssClass="control-label text-star" runat="server">損失原因</asp:Label>
                                    </td>
                                    <td colspan="3">
                                ...
                                <tr>
                                    <td class="text-center">
                                        <asp:Label CssClass="control-label text-star" runat="server">應收件數</asp:Label>
                                        <asp:Label ID="labelA" CssClass="text-red" runat="server"></asp:Label>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtONB_RECEIVE" CssClass="tb tb-s" OnKeyPress="txtKeyNumber()" runat="server"></asp:TextBox>&nbsp;&nbsp;
                                        <asp:Label CssClass="control-label" runat="server">件</asp:Label>
                                        <asp:Label ID="lblONB_CLAIM_BREAK" CssClass="control-label" runat="server"></asp:Label>
                                    </td>
                                    <td class="text-center">
                                        <asp:Label CssClass="control-label text-star" runat="server">實收件數</asp:Label>
                                        <asp:Label ID="labelB" CssClass="text-red" runat="server"></asp:Label>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtONB_ACTUAL_RECEIVE" CssClass="tb tb-s" OnKeyPress="txtKeyNumber()" runat="server"></asp:TextBox>&nbsp;&nbsp;
                                        <asp:Label CssClass="control-label" runat="server">件</asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtONB_CLAIM_BREAK" CssClass="tb tb-s" OnKeyPress="txtKeyNumber()" runat="server"></asp:TextBox>&nbsp;&nbsp;
                                        <asp:Label CssClass="control-label" runat="server">件</asp:Label>
                                    </td>
                                    <td class="text-center">
                                    ...
                                    <td>
                                        ...
                                        <asp:Label CssClass="control-label" runat="server">件</asp:Label>
                                        <%--<asp:Label CssClass="control-label" runat="server">(應收件數-實收件數)</asp:Label>--%>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="text-center">
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtONB_CLAIM_CURRENCY_RATE" CssClass="tb tb-s" OnKeyPress="txtKeyNumber()" runat="server"></asp:TextBox>&nbsp;&nbsp;
                                    </td>
                                </tr>
                                <tr>
                                    <td class="text-center">
                                        <asp:Label CssClass="control-label" runat="server">索賠金額(台幣)</asp:Label>
                                    </td>
                                    <td colspan="3">
                                        <asp:TextBox ID="txtONB_CLAIM_AMOUNT_NTD" CssClass="tb tb-m" OnKeyPress="txtKeyNumber()" runat="server"></asp:TextBox>&nbsp;&nbsp;
                                        <asp:Label CssClass="control-label" runat="server">元</asp:Label>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table class="table table-bordered">
                                <tr>
                                    <td class="text-center" style="width: 150px;">
                                        <asp:Label CssClass="control-label" runat="server">軍種申請理賠來文文號</asp:Label>
                                    </td>
                                    <td style="width: 300px;">
                                        <asp:TextBox ID="txtOVC_CLAIM_COM_MSG" CssClass="tb tb-l" OnTextChanged="txtOVC_NO_TextChanged" AutoPostBack="true" runat="server"></asp:TextBox>
                                    </td>
                                    <td class="text-center" style="width: 150px;">
                                        <asp:Label CssClass="control-label" runat="server">軍種申請理賠來文日期</asp:Label>
                                    </td>
                                    <td >
                                        <div class="input-append datepicker">
                                            <asp:TextBox ID="txtOVC_CLAIM_COM_DATE" CssClass="tb tb-date" runat="server"></asp:TextBox>
                                            <span class='add-on'><i class="icon-calendar"></i></span>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="text-center">
                                        <asp:Label CssClass="control-label" runat="server">國防採購室申請理賠來文文號</asp:Label>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtOVC_PURCHASE_COM_MSG" CssClass="tb tb-l" OnTextChanged="txtOVC_NO_TextChanged" AutoPostBack="true" runat="server"></asp:TextBox>
                                    </td>
                                    <td  class="text-center">
                                        <asp:Label CssClass="control-label" runat="server">國防採購室申請理賠來文日期</asp:Label>
                                    </td>
                                    <td>
                                        <div class="input-append datepicker">
                                            <asp:TextBox ID="txtOVC_PURCHASE_COM_DATE" CssClass="tb tb-date" runat="server"></asp:TextBox>
                                            <span class='add-on'><i class="icon-calendar"></i></span>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="text-center">
                                        <asp:Label CssClass="control-label" runat="server">軍種撤銷保留索賠權來文文號</asp:Label>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtOVC_CLAIM_REV_MSG" CssClass="tb tb-l" OnTextChanged="txtOVC_NO_TextChanged" AutoPostBack="true" runat="server"></asp:TextBox>
                                    </td>
                                    <td  class="text-center">
                                        <asp:Label CssClass="control-label" runat="server">軍種撤銷保留索賠權來文日期</asp:Label>
                                    </td>
                                    <td>
                                        <div class="input-append datepicker">
                                            <asp:TextBox ID="txtOVC_CLAIM_REV_DATE" CssClass="tb tb-date" runat="server"></asp:TextBox>
                                            <span class='add-on'><i class="icon-calendar"></i></span>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="text-center">
                                        <asp:Label CssClass="control-label" runat="server">國防採購室撤銷保留索賠權來文文號</asp:Label>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtOVC_PURCHASE_REV_MSG" CssClass="tb tb-l" OnTextChanged="txtOVC_NO_TextChanged" AutoPostBack="true" runat="server"></asp:TextBox>
                                    </td>
                                    <td  class="text-center">
                                        <asp:Label CssClass="control-label" runat="server">國防採購室撤銷保留索賠全來文日期</asp:Label>
                                    </td>
                                    <td>
                                        <div class="input-append datepicker">
                                            <asp:TextBox ID="txtOVC_PURCHASE_REV_DATE" CssClass="tb tb-date" runat="server"></asp:TextBox>
                                            <span class='add-on'><i class="icon-calendar"></i></span>
                                        </div>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                       ...
                                       <%--<asp:Label ID="Label2" CssClass="control-label" Text="mapproveLabel" runat="server"></asp:Label>--%>
                                    </td>
                                    <td class="text-center">
                ...
                <footer class="panel-footer text-center">
                    <!--網頁尾-->
                    <asp:Button CssClass="btn-warning btnw2" OnClick="btnSave_Click" Text="更新" runat="server" />
                    <asp:Button CssClass="btn-success btnw4" OnClick="btnBack_Click" Text="回上頁" runat="server" />
                </footer>
            </section>
        </div>
    </div>
