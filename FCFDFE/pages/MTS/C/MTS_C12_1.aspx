<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MTS_C12_1.aspx.cs" Inherits="FCFDFE.pages.MTS.C.MTS_C12_1" %>
                        ...
                        <div class="cmxform form-horizontal tasi-form">
                            ...
                            <table class="table table-bordered">
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtOVC_CLAIM_NO" CssClass="tb tb-m text-toUpper" runat="server"></asp:TextBox>
                                    </td>
                            ...
                            <asp:GridView ID="GV_TBGMT_CLAIM" DataKeyNames="CLAIM_SN" CssClass="table data-table table-striped border-top" AutoGenerateColumns="false" 
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField HeaderText="申請者" DataField="OVC_CREATE_LOGIN_ID" />
                                      <asp:TemplateField HeaderText="" HeaderStyle-Width="13em">
                                        <ItemTemplate>
                                            <asp:Button CssClass="btn-warning" Text="修改" CommandName="btnModify" runat="server"/>
                                            <asp:Button CssClass="btn-danger" Text="刪除" CommandName="btnDel" runat="server"/>
                                            <asp:Button CssClass="btn-success" Text="列印" CommandName="btnPrint" runat="server"/>
                                        </ItemTemplate>
                                     </asp:TemplateField>
                                </Columns>
                            </asp:GridView>
