<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MTS_D12_2.aspx.cs" Inherits="FCFDFE.pages.MTS.D.MTS_D12_2" %>
                            ...
                            <div class="form" style="border: 5px;">
                                <div class="cmxform form-horizontal tasi-form">
                                    <div class="text-right">
                                        <asp:LinkButton OnClick="btnBack_Click" Text="回出口結報申請表-管理" runat="server"></asp:LinkButton>
                                    </div>
