...
{
    public partial class MTS_A29_2 : Page
    {
        ...
        private void dataImport()
        {
            ...
            if (ICR != null)
            {
                ...
                //lblODT_CUSTOM_DATE.Text = ICR.OVC_BLD_NO;
            }
        ...
        protected void btnNew_Click(object sender, EventArgs e)
        {
            ...
            //string strODT_VALIDITY_DATE = lblODT_VALIDITY_DATE.Text;
            ...
            //string strODT_CUSTOM_DATE = lblODT_CUSTOM_DATE.Text;
            ...
            DateTime dateODT_REQUIRE_DATE, dateODT_RECEIVE_DATE, dateODT_PROCESS_DATE, dateODT_STRATEGY_PROCESS_DATE, dateODT_VALIDITY_DATE, dateODT_CUSTOM_DATE,
            ...
            if (etr != null)
                FCommon.MessageBoxShow(this, $"提單編號：{ id } 之時程管制表 已存在！", $"MTS_A29_1{ getQueryString() }", false);
            else if (strMessage.Equals(string.Empty))
            {
                try
                {
                    #region TBGMT_ETR 新增資料
                    etr = new TBGMT_ETR();
                    etr.OVC_BLD_NO = id;
                    ...
                    etr.OVC_CREATE_LOGIN_ID = strUserId;
                    etr.ETR_SN = Guid.NewGuid();

                    MTSE.TBGMT_ETR.Add(etr);
                    MTSE.SaveChanges();
                    FCommon.syslog_add(strUserId, Request.ServerVariables["REMOTE_ADDR"].ToString(), etr.GetType().Name, this, "新增");
                    #endregion
                    ...
                    FCommon.AlertShow(PnWarning, "success", "系統訊息", $"提單編號：{ id } 之時程管制表 新增成功");
        ...
        {
            Response.Redirect($"MTS_A29_1{ getQueryString() }");
        }
    }
}