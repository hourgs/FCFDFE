<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MTS_A29_1.aspx.cs" Inherits="FCFDFE.pages.MTS.A.MTS_A29_1" %>
    ...
    <div class="row">
        <div style="width: 1000px; margin:auto;">
            <section class="panel">
                <header  class="title">
                    <!--標題-->
                    <div>軍品出口作業時程管制表-Step1 選擇提單</div>
                </header>
                            ...
                            <asp:GridView ID="GVTBGMT_BLD" DataKeyNames="OVC_BLD_NO" CssClass="table data-table table-striped border-top text-center data-table" AutoGenerateColumns="false" 
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="" ItemStyle-CssClass="text-center">
                                        <ItemTemplate>
                                            <asp:button ID="btnNew" CssClass="btn-warning btnw2" Text="建立" CommandName="btnNew" CommandArgument='' runat="server"/>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                            </asp:GridView>
