<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MTS_A13_2.aspx.cs" Inherits="FCFDFE.pages.MTS.A.MTS_A13_2" %>
        ...
        <div style="width: 1000px; margin:auto;">
            <section class="panel">
                            ...
                            <table class="table table-bordered text-center">
                                ...
                                <tr>
                                    ...
                                    <td colspan="3" class="text-left">
                                        ...
                                        <asp:Button ID="btnResetOVC_DEPT_CDE_CODE" cssclass="btn-default btnw4" Text="資料清空" OnClick="btnResetOVC_DEPT_CDE_CODE_Click" runat="server"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-left">
                                        <div class="input-append datepicker">
                                            <asp:TextBox ID="txtODT_TRANSMTSR_DATE" CssClass="tb tb-date" runat="server"></asp:TextBox>
                                            <div class="add-on"><i class="icon-calendar"></i></div>
                                        </div>
                                    </td>
                                </tr>
                ...
                <footer class="panel-footer text-center">
                    <!--網頁尾-->
                    <asp:Button cssclass="btn-warning btnw6" Text="新增管制簿" OnClick="btnNew_Click" runat="server" />
                    <asp:Button cssclass="btn-warning btnw6" Text="回首頁" OnClick="btnHome_Click" runat="server" />
                </footer>
            </section>
        </div>
    </div>
