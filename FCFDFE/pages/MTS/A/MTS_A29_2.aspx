<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MTS_A29_2.aspx.cs" Inherits="FCFDFE.pages.MTS.A.MTS_A29_2" %>
    ...
    <div class="row">
        <div style="width: 1000px; margin:auto;">
            <section class="panel">
                <header  class="title">
                    <!--標題-->
                    <div>軍品出口作業時程管制表-Step2 填寫時程管制表資料</div>
                </header>
                    ...
                    <div class="form" style="border: 5px;">
                        <div class="cmxform form-horizontal tasi-form">
                            ...
                            <div class="text-right" style="padding: 10px;">
                                <asp:LinkButton CssClass="btn-success btnw8" OnClick="btnBack_Click" Text="回時程管制表建立" runat="server"></asp:LinkButton>
                            </div>
                            <table class="table table-bordered text-center">
                                ...
                                <tr>
                                    ...
                                    <td class="text-left">
                                       <asp:Label ID="lblODT_VALIDITY_DATE" CssClass="control-label" Visible="false" runat="server"></asp:Label>
                                        <div class="input-append datepicker">
                                ...
                                <tr>
                                    ...
                                    <td class="text-left">
                                        <asp:Label ID="lblODT_CUSTOM_DATE" CssClass="control-label" Visible="false" runat="server"></asp:Label>
                                        <div class="input-append datepicker">
                            ...
                            <div class="text-center">
                                <asp:Button ID="btnNew" CssClass="btn-warning btnw7" Text="新增時程管制表" OnClick="btnNew_Click" runat="server" />
                                &nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <footer class="panel-footer text-center">
                    <!--網頁尾-->
                    <%--<asp:HyperLink runat="server" NavigateUrl="~/pages/MTS/A/MTS_A29_1.aspx">繼續新增時程管制表</asp:HyperLink>--%>
                    <asp:LinkButton ID="btnBack" Visible="false" OnClick="btnBack_Click" Text="繼續新增時程管制表" runat="server"></asp:LinkButton>
                </footer>
            </section>
        </div>
    </div>
