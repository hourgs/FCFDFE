<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MTS_A12_2.aspx.cs" Inherits="FCFDFE.pages.MTS.A.MTS_A12_2" %>
        ...
        <div style="width: 1000px; margin: auto;">
            <section class="panel">
                        ...
                        <div class="cmxform form-horizontal tasi-form">
                            ...
                            <table class="table table-bordered text-center">
                                ...
                                <tr>
                                    ...
                                    <td class="text-left">
                                        <asp:DropDownList ID="drpONB_DANGER_PRO" CssClass="tb tb-s" runat="server">
                                ...
                                <tr>
                                    <td>
                                        <asp:Label CssClass="control-label" runat="server">資料傳送日期</asp:Label>
                                    </td>
                                    <td colspan="3" class="text-left">
                            ...
                            <div class="text-center">
                                ...
                                <asp:Button ID="btnNext" CssClass="btn-success btnw4" style="margin-left: 10px;" Text="下一筆" OnClick="btnNext_Click" runat="server" />
                                <asp:Button CssClass="btn-warning btnw2" style="margin-left: 30px;" Text="更新" OnClick="btnModify_Click" runat="server" />
                                <asp:Button CssClass="btn-danger btnw2" style="margin-left: 10px;" Text="刪除" OnClick="btnDel_Click" OnClientClick="if (confirm('確定刪除此資料?') == false) return false;" runat="server" />
                            </div>
                        </div>
                    </div>
                </div>
                <footer class="panel-footer text-center">
                    <!--網頁尾-->
                    <asp:Button ID="btnHome" CssClass="btn-success btnw3" OnClick="btnHome_Click" runat="server" Text="回首頁" />
                </footer>
            </section>
        </div>
    </div>
