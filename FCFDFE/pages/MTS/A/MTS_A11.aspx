<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MTS_A11.aspx.cs" Inherits="FCFDFE.pages.MTS.A.MTS_A11" %>
                        ...
                        <div class="cmxform form-horizontal tasi-form">
                            ...
                            <table class="table table-bordered text-center">
                                ...
                                <tr>
                                    ...
                                    <td class="text-left">
                                        <asp:DropDownList ID="drpOVC_SHIP_COMPANY" OnSelectedIndexChanged="drpPORT_SelectedIndexChanged" AutoPostBack="true" CssClass="tb tb-s" runat="server"></asp:DropDownList>
                                    </td>
                                    <td>
                                        <asp:Label CssClass="control-label" runat="server">海空運別</asp:Label>
                                    </td>
                                    <td class="text-left">
                                        <asp:DropDownList ID="drpOVC_SEA_OR_AIR" OnSelectedIndexChanged="drpPORT_SelectedIndexChanged" AutoPostBack="true" CssClass="tb tb-s" runat="server"></asp:DropDownList>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
