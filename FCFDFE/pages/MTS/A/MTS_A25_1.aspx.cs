...
{
    public partial class MTS_A25_1 : Page
    {
            ...
            if (strMessage.Equals(string.Empty))
            {
                var query =
                    ...
                    select new
                    {
                        ...
                        ODT_PLN_ARRIVE_DATE = FCommon.getDateTime(bld.ODT_ACT_ARRIVE_DATE),
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (FCommon.getAuth(this))
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    string strOVC_BLD_NO, strOVC_SHIP_NAME, strOVC_VOYAGE, strOVC_TRANSER_DEPT_CDE, strOVC_IS_SECURITY;
                    ...
                    if (FCommon.getQueryString(this, "OVC_TRANSER_DEPT_CDE", out strOVC_TRANSER_DEPT_CDE, true))
                        drpOVC_TRANSER_DEPT_CDE.SelectedValue = strOVC_TRANSER_DEPT_CDE;
                    if (FCommon.getQueryString(this, "OVC_IS_SECURITY", out strOVC_IS_SECURITY, true))
                        rdoOVC_IS_SECURITY.SelectedValue = strOVC_IS_SECURITY;
                    if (boolImport)
                        dateImport();
                }
            }
        ...
        {
            Response.Redirect($"MTS_A25_2{ getQueryString() }");
        }
        ...
        protected void GVTBGMT_BLD_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            switch (e.CommandName)
            {
                case "btnModify":
                    ...
                    Response.Redirect($"MTS_A25_3{ strQueryString }");
                    break;
                default:
                    break;
            }
