<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MTS_A17_2.aspx.cs" Inherits="FCFDFE.pages.MTS.A.MTS_A17_2" %>
    ...
    <div class="row">
        <div style="width: 1000px; margin:auto;">
            <section class="panel">
                <header  class="title">
                    <!--標題-->
                    <div>進口物資管制接配紀錄表-Step2 填寫接配資料</div>
                </header>
                            ...
                            <table class="table table-bordered text-center">
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <asp:Button ID="btnCreate_CTN" cssclass="btn-success btnw4" Text="新增貨櫃" OnClick="btnCreate_CTN_Click" runat="server" />
                                    </td>
                                    <td colspan="3" class="td-inner-table">
                                        <asp:Panel ID="PnMessage_CTN" runat="server"></asp:Panel>
                                ...
                                <tr>
                                    ...
                                    <td colspan="3" class="td-inner-table">
                                        <table class="table table-bordered text-center table-inner">
                                            ...
                                            <tr>
                                                <td>
                                                    <asp:TextBox ID="txtONB_ACTUAL_RECEIVE" CssClass="tb tb-full" OnKeyPress="txtKeyNumber()" runat="server">0</asp:TextBox>
                                                </td>
                                                <td>
                                                    <asp:TextBox ID="txtONB_OVERFLOW" CssClass="tb tb-full" OnKeyPress="txtKeyNumber()" runat="server">0</asp:TextBox>
                                                </td>
                                                <td>
                                                    <asp:TextBox ID="txtONB_LESS" CssClass="tb tb-full" OnKeyPress="txtKeyNumber()" runat="server">0</asp:TextBox>
                                                </td>
                                                <td>
                                                    <asp:TextBox ID="txtONB_BROKEN" CssClass="tb tb-full" OnKeyPress="txtKeyNumber()" runat="server">0</asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>								
                                ...
                                <tr>
                                    <td style="vertical-align:middle;"><asp:Label CssClass="control-label" runat="server">分運明細</asp:Label><br>
                                        <asp:Button ID="btnCreate_DETAIL" cssclass="btn-success btnw4" Text="箱號輸入" OnClick="btnCreate_DETAIL_Click" runat="server" /><br>
                                    ...
                                    <td colspan="3" class="td-inner-table">
                                        ...
                                        <%--<asp:Label CssClass="control-label" runat="server" Text="[newLabel]" Visible="false"></asp:Label>--%>
                                        ...
                                        <%--<table id="Ctable" class="table table-bordered text-center" visible="false" runat="server">
                                            <tr>
                                                <td>
                                                    <asp:TextBox ID="txtOVC_DEPT_CDE" CssClass="tb tb-s" runat="server"></asp:TextBox>
                                                    <asp:TextBox ID="txtOVC_ONNAME" CssClass="tb tb-s" hidden="true" runat="server"></asp:TextBox>
                                                    <asp:Button ID="btnUnit" Text="單位查詢" cssclass="btn-success btnw4" OnClientClick="OpenWindow()" OnClick="btnUnit_Click" runat="server" />
                                                </td>
                                                <td>
                                                    <asp:TextBox ID="txtOVC_BOX_NO" CssClass="tb tb-s" runat="server" />
                                                </td>
                                                <td>
                                                    <asp:TextBox ID="txtONB_ACTUAL_RECEIVE" CssClass="tb tb-xs" OnKeyPress="txtKeyNumber()" runat="server" />
                                                </td>
                                                <td>
                                                    <asp:TextBox ID="txtONB_OVERFLOW" CssClass="tb tb-xs" OnKeyPress="txtKeyNumber()" runat="server" />
                                                </td>
                                                <td>
                                                    <asp:TextBox ID="txtONB_LESS" CssClass="tb tb-xs" OnKeyPress="txtKeyNumber()" runat="server" />
                                                </td>
                                                <td>
                                                    <asp:TextBox ID="txtONB_BROKEN" CssClass="tb tb-xs" OnKeyPress="txtKeyNumber()" runat="server" />
                                                </td>
                                                <td>
                                                    <asp:Button ID="btnSave" CssClass="btn-success btnw2" Text="儲存" OnClick="btnSave_Click" runat="server"/>
                                                </td>
                                                <td>
                                                    <asp:Button ID="btnCancel" CssClass="btn-success btnw2" Text="取消" OnClick="btnCancel_Click" runat="server"/>
                                                </td>
                                            </tr>
                                        </table>--%>
                                    </td>
                ...
                <footer class="panel-footer text-center">
                    <!--網頁尾-->
                    <asp:Button ID="btnNew" cssclass="btn-warning" Text="新增接配紀錄表" OnClick="btnNew_Click" runat="server" />
