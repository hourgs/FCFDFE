<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BLDDATA.aspx.cs" Inherits="FCFDFE.pages.MTS.A.BLDDATA" %>
                ...
                <section class="panel">                          
                    <table class="table table-bordered text-center">                             
                        ...
                        <tr>
                            ...
                            <td class="text-left">
                                <asp:Label ID="lblONB_CARRIAGE_CURRENCY_I" CssClass="control-label" runat="server"></asp:Label>
                            </td>
                        </tr>
                        <tr>
