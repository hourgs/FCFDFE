...
<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MTS_A28_2.aspx.cs" Inherits="FCFDFE.pages.MTS.A.MTS_A28_2" %>
        ...
        <div style="width: 1000px; margin:auto;">
            <section class="panel">
                            ...
                            <table class="table table-bordered text-center">
                                ...
                                <tr>
                                    <td colspan="2" class="td-inner-table text-left">
                                        <asp:GridView ID="GVTBGMT_EDF_DETAIL" CssClass="table table-striped border-top text-center table-inner dt-fixed" AutoGenerateColumns="false" OnRowCreated="GVTBGMT_EDF_DETAIL_RowCreated" OnPreRender="GVTBGMT_EDF_DETAIL_PreRender" runat="server">
                                            <Columns>
                ...
                <footer class="panel-footer" style="text-align: center;">
                    <!--網頁尾-->
                    <asp:Button ID="btnModify" CssClass="btn-warning btnw6" Text="更新出口報單" OnClick="btnModify_Click" runat="server" />
                </footer>
            </section>
        </div>
    </div>
