<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MPMS_B13_6.aspx.cs" Inherits="FCFDFE.pages.MPMS.B.MPMS_B13_6" %>
                ...
                <div class="panel-body" style=" border: solid 2px;">
                    <div class="form" style="border: 5px;">
                        <div class="cmxform form-horizontal tasi-form">
                            ...
                            <table class="table table-bordered text-center">
                                ...
                                <tr id="trMemo" runat="server" visible="false">
                                    <td>
                                        ...
                                        <asp:Button ID="Btndel" CssClass="btn-success btnw2" OnClick="Btndel_Click" runat="server" Text="刪除" />
                                    </td>
                            ...
                            <p></p>
                            <asp:GridView ID="GV_OutPurEditing" CssClass="table data-table table-striped border-top" AutoGenerateColumns="false" OnPreRender="GV_OutPurEditing_PreRender" runat="server">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="標準用語" >
                                        <ItemTemplate>
                   		                    <asp:TextBox ID="txtSTANDARD" CssClass="tb tb-full" TextMode="MultiLine" Height="100%" Width="100%" Text='<%# Bind("OVC_MEMO") %>' runat="server"></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField> 
