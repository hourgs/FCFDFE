...
{
    public partial class MPMS_B13_5 : System.Web.UI.Page
    {
        ...
        protected void BtnSave_Click(object sender, EventArgs e)
        {
            ...
            TextBox txtMemo = (TextBox)GV_UseSTANDARD.Rows[gvRowIndex].Cells[2].FindControl("txtSTANDARD");
        ...
        protected void btn_Click(object sender, EventArgs e)
        {
            ...
            GridviewRowSpan();
            GV_UseSTANDARD.Rows[0].Cells[0].Text = "目前編輯：" + btn.Text;
            trMemo.Visible = true;
            MemoMainImport();
        }
        ...
        protected void Btndel_Click(object sender, EventArgs e)
        {
            ...
            tbm1220_1 = mpms.TBM1220_1.Where(o => o.OVC_PURCH.Equals(strPurchNum) && o.OVC_IKIND.Equals("M11")).FirstOrDefault();
            if (tbm1220_1 != null)
            {
        ...
        protected void GV_UseSTANDARD_PreRender(object sender, EventArgs e)
        {
        ...
        private void SaveMemo(string strMemo, string strCheck, string strStandard)
        {
            ...
            var queryExist = mpms.TBM1220_1.Where(table => table.OVC_PURCH.Equals(strPurchNum)
                                && table.OVC_IKIND.Equals("M11")).FirstOrDefault();
            if (queryExist == null)
            {
                //null表示沒資料要新增
                TBM1220_1 tbm1220_1 = new TBM1220_1();
                tbm1220_1.OVC_PURCH = strPurchNum;
                tbm1220_1.OVC_IKIND = "M11";
                tbm1220_1.ONB_NO = 1;
            ...
            else
            {
                TBM1220_1 table1220_1 = mpms.TBM1220_1.Where(o => o.OVC_PURCH.Equals(strPurchNum)
                                                                   && o.OVC_IKIND.Equals("M11")).FirstOrDefault();
        ...
        {
            //合併下方GV第一欄
            foreach (GridViewRow rows in GV_UseSTANDARD.Rows)
            {
                GV_UseSTANDARD.Rows[0].Cells[0].RowSpan += 1;
                if (rows.RowIndex != 0)
        ...
        {
            txtOVC_MEMO.Text = "";
               var query = mpms.TBM1220_1.Where(o => o.OVC_PURCH.Equals(strPurchNum) && o.OVC_IKIND.Equals("M11")).FirstOrDefault();
            if(query!=null)
        ...
        private void Gridevent(string item)
        {
            ...
            ViewState["hasRows"] = FCommon.GridView_dataImport(GV_UseSTANDARD, dtSubItem, strField);
        }
    }
}