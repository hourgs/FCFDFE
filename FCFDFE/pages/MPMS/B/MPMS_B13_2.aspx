<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MPMS_B13_2.aspx.cs" Inherits="FCFDFE.pages.MPMS.B.MPMS_B13_2" %>
                           ...
                           <asp:Panel ID="pn_Button" HorizontalAlign="Center" runat="server"></asp:Panel>
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField ItemStyle-Width="10%" HeaderText="選擇">
                                        <ItemTemplate>
                                            ...
                                            <asp:Button ID="btn_save" CssClass="btn-success btnw4" Text="直接存檔" OnClick="btn_save_Click" CommandName="按鈕屬性" runat="server" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                            ...
                            <div class="text-center">
                                ...
                                <table class="table table-bordered text-center">
                                    <tr>
                                        <td>
                                            <asp:Button ID="btn_EditSave" CssClass="btn-success btnw2" Text="存檔" OnClick="btn_EditSave_Click" runat="server" /></td>
                                        <td>
