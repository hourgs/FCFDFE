<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MPMS_B15_1.aspx.cs" Inherits="FCFDFE.pages.MPMS.B.MPMS_B15_1" %>
                    ...
                    <div class="form" style="border: 5px;">
                        <div class="cmxform form-horizontal tasi-form">
                            ...
                            <table class="table table-bordered text-center">
                                ...
                                <tr>
                                    <td colspan="2">
                                        <asp:Label CssClass="control-label" runat="server" Text="確認轉呈後，建議重新列印物資申請書與採購計畫清單"></asp:Label>
                                    </td>
                                </tr>
                            </table>
                        </div>
