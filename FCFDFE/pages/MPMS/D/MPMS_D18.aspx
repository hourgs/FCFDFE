<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MPMS_D18.aspx.cs" Inherits="FCFDFE.pages.MPMS.D.MPMS_D18" %>
                    ...
                    <asp:GridView ID="gvTbm1303" CssClass="table data-table table-striped border-top text-center" AutoGenerateColumns="false" OnRowCommand="gvTbm1303_RowCommand" runat="server">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="其他作業" ItemStyle-Width="10%">
                                <ItemTemplate>
                                    <p><asp:Button ID="btnToD18_3" CssClass="btn-default" Text="廠商編輯" CommandName="ToD18_3" runat="server" /></p>
                                    <asp:Button ID="btnToD18_7" CssClass="btn-default" Text="開標結果" CommandName="ToD18_7" runat="server" />
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                    </asp:GridView>
