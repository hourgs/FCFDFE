<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MPMS_D25.aspx.cs" Inherits="FCFDFE.pages.MPMS.D.MPMS_D25" %>
                    ...
                    <div class="form" style="border: 5px;">
                        <table class="table table-bordered text-center">
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    <asp:TextBox ID="txtOVC_DWAIT" CssClass="tb tb-s" runat="server"></asp:TextBox><asp:Label CssClass="control-label" runat="server">日</asp:Label><asp:Label CssClass="control-label text-red" runat="server">(限制性招標本欄位請自行填入)</asp:Label></td>
                                <td colspan="3" class=" text-left">
                                    <asp:Label CssClass="control-label text-red" runat="server">等標期提示：限制議價合理定訂</asp:Label></td>
                            </tr>
                            <tr>
                                <td>
                                    <asp:Label CssClass="control-label" runat="server">說明</asp:Label></td>
                                <td colspan="5">
                                    <asp:TextBox ID="txtOVC_DESC" TextMode="MultiLine" Rows="5" CssClass="textarea tb-full" runat="server"></asp:TextBox></td>
                            </tr>
                            <tr>
                                <td>
