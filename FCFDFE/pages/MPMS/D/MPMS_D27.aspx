<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MPMS_D27.aspx.cs" Inherits="FCFDFE.pages.MPMS.D.MPMS_D27" %>
                ...
                <div class="panel-body" style="border: solid 2px;">
                    <div class="form" style="border: 5px;">
                        ...
                        <table class="table table-bordered text-center" style="margin-bottom:0px;">
                            ...
                            <tr class="no-bordered">
                                ...
                                <td><asp:Label CssClass="control-label" runat="server">原公告內容：</asp:Label>
                                    ...
                                    <asp:RadioButton ID="rdoOVC_DOPEN_input" CssClass="radioButton rb-complex position-left" runat="server" />
                                        ...
                                        <asp:Label ID="Label1" CssClass="control-label position-left" runat="server">辦理。</asp:Label>
                                        </div>
                                    <br />
                            ...
                            <tr class="no-bordered no-bordered-seesaw">
                                <td>
                                    <asp:Label CssClass="control-label position-left text-red" runat="server">2.唪核後辦理後續公告事宜。</asp:Label></td>
                            </tr>
                            </table>
