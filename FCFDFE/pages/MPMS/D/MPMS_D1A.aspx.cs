...
{
    public partial class MPMS_D1A : System.Web.UI.Page
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (tbmBID_BACK != null)
            {
                ...
                tbmBID_BACK.OVC_REASON_1 = chkOVC_REASON_1.Checked == true ? chkOVC_REASON_1.Text : string.Empty;
                tbmBID_BACK.OVC_REASON_2 = chkOVC_REASON_2.Checked == true ? chkOVC_REASON_2.Text : string.Empty;
                tbmBID_BACK.OVC_REASON_3 = chkOVC_REASON_3.Checked == true ? chkOVC_REASON_3.Text : string.Empty;

                if (chkOVC_REASON_4.Checked == true)
                {
                    tbmBID_BACK.OVC_REASON_41 = GetSaveValue(chkOVC_REASON_4_1, 0);
                    tbmBID_BACK.OVC_REASON_42 = GetSaveValue(chkOVC_REASON_4_1, 1);
                    tbmBID_BACK.OVC_REASON_43 = GetSaveValue(chkOVC_REASON_4_1, 2);
                    tbmBID_BACK.OVC_REASON_44 = GetSaveValue(chkOVC_REASON_4_2, 0);
                    tbmBID_BACK.OVC_REASON_45 = GetSaveValue(chkOVC_REASON_4_2, 1);
                }
                else
                {
                ...
                tbmBID_BACK.OVC_REASON_5 = chkOVC_REASON_5.Checked == true ? chkOVC_REASON_5.Text : string.Empty;
            ...
            else
            {
                ...
                tbmBID_BACK_new.OVC_REASON_1 = chkOVC_REASON_1.Checked == true ? chkOVC_REASON_1.Text : string.Empty;
                tbmBID_BACK_new.OVC_REASON_2 = chkOVC_REASON_2.Checked == true ? chkOVC_REASON_2.Text : string.Empty;
                tbmBID_BACK_new.OVC_REASON_3 = chkOVC_REASON_3.Checked == true ? chkOVC_REASON_3.Text : string.Empty;
                if (chkOVC_REASON_4.Checked == true)
                {
                    tbmBID_BACK_new.OVC_REASON_41 = GetSaveValue(chkOVC_REASON_4_1, 0);
                    tbmBID_BACK_new.OVC_REASON_42 = GetSaveValue(chkOVC_REASON_4_1, 1);
                    tbmBID_BACK_new.OVC_REASON_43 = GetSaveValue(chkOVC_REASON_4_1, 2);
                    tbmBID_BACK_new.OVC_REASON_44 = GetSaveValue(chkOVC_REASON_4_2, 0);
                    tbmBID_BACK_new.OVC_REASON_45 = GetSaveValue(chkOVC_REASON_4_2, 1);
                }
                else
                {
                ...
                tbmBID_BACK_new.OVC_REASON_5 = chkOVC_REASON_5.Checked == true ? chkOVC_REASON_5.Text : string.Empty;
        ...
        {
            //點擊 回開標紀錄選擇畫面
            string send_url = "~/pages/MPMS/D/MPMS_D19.aspx?OVC_PURCH=" + strOVC_PURCH + "&OVC_PUR_AGENCY=" + strOVC_PUR_AGENCY
                            + "&OVC_PURCH_5=" + strOVC_PURCH_5;
            Response.Redirect(send_url);
        }
        ...
        protected void lbtnToWordD1A_Click(object sender, EventArgs e)
        {
            GetWordD19_1_6();
        }
        ...
        private void DataImport()
        {
            ...
            */
            ...
            if(tbmBID_BACK != null)
            {
                ...
                chkOVC_REASON_1.Checked = tbmBID_BACK.OVC_REASON_1 == chkOVC_REASON_1.Text ? true : false;
                chkOVC_REASON_2.Checked = tbmBID_BACK.OVC_REASON_2 == chkOVC_REASON_2.Text ? true : false;
                chkOVC_REASON_3.Checked = tbmBID_BACK.OVC_REASON_3 == chkOVC_REASON_3.Text ? true : false;
                if (tbmBID_BACK.OVC_REASON_41 != null || tbmBID_BACK.OVC_REASON_42 != null || tbmBID_BACK.OVC_REASON_43 != null || tbmBID_BACK.OVC_REASON_44 != null || tbmBID_BACK.OVC_REASON_45 != null)
                    chkOVC_REASON_4.Checked = true;
                SetCheckeds(chkOVC_REASON_4_1, strOVC_REASON_4_1);
                SetCheckeds(chkOVC_REASON_4_2, strOVC_REASON_4_2);
                chkOVC_REASON_5.Checked = tbmBID_BACK.OVC_REASON_5 == chkOVC_REASON_5.Text ? true : false;
        ...
        private void GetWordD19_1_6()
        {
            ...
            string fileName = "13." + strOVC_PURCH + "開標結果通知押標金投標文件退還紀錄表.docx";
            File.Copy(targetPath + "D19_1_6.docx", targetPath + fileName);
