...
{
    public partial class MPMS_D18_1 : System.Web.UI.Page
    {
        ...
        protected void gvTBM1314_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            {
                //點擊 更多 按鈕
                //string send_url = "~/pages/MPMS/D/MPMS_D18_2.aspx?OVC_PURCH=" + strOVC_PURCH + "&OVC_DOPEN=" + strOVC_DOPEN
            ...
            else if (e.CommandName == "Chnage")
            {
                ...
                if (tbm1314_Edit != null)
                {
                    ...
                    rdoOVC_MINIS_4.SelectedValue = tbm1314_Edit.OVC_MINIS_4;
                    rdoOVC_MINIS_5.SelectedValue = tbm1314_Edit.OVC_MINIS_5;
                    rdoOVC_MINIS_6.SelectedValue = tbm1314_Edit.OVC_MINIS_6;
                    rdoOVC_MINIS_7.SelectedValue = tbm1314_Edit.OVC_MINIS_7;
                    rdoOVC_MINIS_8.SelectedValue = tbm1314_Edit.OVC_MINIS_8;
                    rdoOVC_MINIS_9.SelectedValue = tbm1314_Edit.OVC_MINIS_9;
                    rdoOVC_MINIS_10.SelectedValue = tbm1314_Edit.OVC_MINIS_10;
                    rdoOVC_MINIS_11.SelectedValue = tbm1314_Edit.OVC_MINIS_11;
                    rdoOVC_MINIS_12.SelectedValue = tbm1314_Edit.OVC_MINIS_12;
                    ...
                    txtONB_MINIS_4.Text = tbm1314_Edit.ONB_MINIS_4?.ToString();
                    txtONB_MINIS_5.Text = tbm1314_Edit.ONB_MINIS_5?.ToString();
                    txtONB_MINIS_6.Text = tbm1314_Edit.ONB_MINIS_6?.ToString();
                    txtONB_MINIS_7.Text = tbm1314_Edit.ONB_MINIS_7?.ToString();
                    txtONB_MINIS_8.Text = tbm1314_Edit.ONB_MINIS_8?.ToString();
                    txtONB_MINIS_9.Text = tbm1314_Edit.ONB_MINIS_9?.ToString();
                    txtONB_MINIS_10.Text = tbm1314_Edit.ONB_MINIS_10?.ToString();
                    txtONB_MINIS_11.Text = tbm1314_Edit.ONB_MINIS_11?.ToString();
                    txtONB_MINIS_12.Text = tbm1314_Edit.ONB_MINIS_12?.ToString();
                    ...
                    rdoOVC_KMINIS_4.SelectedValue = tbm1314_Edit.OVC_KMINIS_4;
                    rdoOVC_KMINIS_5.SelectedValue = tbm1314_Edit.OVC_KMINIS_5;
                    rdoOVC_KMINIS_6.SelectedValue = tbm1314_Edit.OVC_KMINIS_6;
                    rdoOVC_KMINIS_7.SelectedValue = tbm1314_Edit.OVC_KMINIS_7;
                    rdoOVC_KMINIS_8.SelectedValue = tbm1314_Edit.OVC_KMINIS_8;
                    rdoOVC_KMINIS_9.SelectedValue = tbm1314_Edit.OVC_KMINIS_9;
                    rdoOVC_KMINIS_10.SelectedValue = tbm1314_Edit.OVC_KMINIS_10;
                    rdoOVC_KMINIS_11.SelectedValue = tbm1314_Edit.OVC_KMINIS_11;
                    rdoOVC_KMINIS_12.SelectedValue = tbm1314_Edit.OVC_KMINIS_12;
                }
            }
        ...
        protected void btnSave_TBM1303_Click(object sender, EventArgs e)
        {
            ...
            if (txtOVC_DAPPROVE.Text != "")
            {
                ...
                if (tbmSTATUS_25 != null)
                {
                    ...
                    tbmSTATUS_25.OVC_PURCH_6 = txtOVC_PURCH_6.Text;
                    mpms.SaveChanges();
                ...
                if (tbmSTATUS_27 == null)
                {
                    TBMSTATUS tbmSTATUS_New = new TBMSTATUS
                    {
                        ...
                        OVC_PURCH_6 = tbmSTATUS_25.OVC_PURCH_6,
                        ONB_TIMES = 1,
            ...
            if (strErrorMsg == "")
            {
                ...
                if (tbm1314 == null)
                {
                    ...
                    TBM1314 tbm1314_new = new TBM1314()
                    {
                        ...
                        ONB_MINIS_4 = txtONB_MINIS_4.Text == "" ? (decimal?)null : decimal.Parse(txtONB_MINIS_4.Text),
                        ONB_MINIS_5 = txtONB_MINIS_5.Text == "" ? (decimal?)null : decimal.Parse(txtONB_MINIS_5.Text),
                        ONB_MINIS_6 = txtONB_MINIS_6.Text == "" ? (decimal?)null : decimal.Parse(txtONB_MINIS_6.Text),
                        ONB_MINIS_7 = txtONB_MINIS_7.Text == "" ? (decimal?)null : decimal.Parse(txtONB_MINIS_7.Text),
                        ONB_MINIS_8 = txtONB_MINIS_8.Text == "" ? (decimal?)null : decimal.Parse(txtONB_MINIS_8.Text),
                        ONB_MINIS_9 = txtONB_MINIS_9.Text == "" ? (decimal?)null : decimal.Parse(txtONB_MINIS_9.Text),
                        ONB_MINIS_10 = txtONB_MINIS_10.Text == "" ? (decimal?)null : decimal.Parse(txtONB_MINIS_10.Text),
                        ONB_MINIS_11 = txtONB_MINIS_11.Text == "" ? (decimal?)null : decimal.Parse(txtONB_MINIS_11.Text),
                        ONB_MINIS_12 = txtONB_MINIS_12.Text == "" ? (decimal?)null : decimal.Parse(txtONB_MINIS_12.Text),
                        ...
                        OVC_MINIS_4 = rdoOVC_MINIS_4.SelectedValue,
                        OVC_MINIS_5 = rdoOVC_MINIS_5.SelectedValue,
                        OVC_MINIS_6 = rdoOVC_MINIS_6.SelectedValue,
                        OVC_MINIS_7 = rdoOVC_MINIS_7.SelectedValue,
                        OVC_MINIS_8 = rdoOVC_MINIS_8.SelectedValue,
                        OVC_MINIS_9 = rdoOVC_MINIS_9.SelectedValue,
                        OVC_MINIS_10 = rdoOVC_MINIS_10.SelectedValue,
                        OVC_MINIS_11 = rdoOVC_MINIS_11.SelectedValue,
                        OVC_MINIS_12 = rdoOVC_MINIS_12.SelectedValue,
                        ...
                        OVC_KMINIS_4 = rdoOVC_KMINIS_4.SelectedValue,
                        OVC_KMINIS_5 = rdoOVC_KMINIS_5.SelectedValue,
                        OVC_KMINIS_6 = rdoOVC_KMINIS_6.SelectedValue,
                        OVC_KMINIS_7 = rdoOVC_KMINIS_7.SelectedValue,
                        OVC_KMINIS_8 = rdoOVC_KMINIS_8.SelectedValue,
                        OVC_KMINIS_9 = rdoOVC_KMINIS_9.SelectedValue,
                        OVC_KMINIS_10 = rdoOVC_KMINIS_10.SelectedValue,
                        OVC_KMINIS_11 = rdoOVC_KMINIS_11.SelectedValue,
                        OVC_KMINIS_12 = rdoOVC_KMINIS_12.SelectedValue,
                    };
        ...
        {
            //點擊 回上一頁
            string send_url = "~/pages/MPMS/D/MPMS_D18.aspx?OVC_PURCH=" + strOVC_PURCH + "&OVC_PURCH_5=" + strOVC_PURCH_5;
            Response.Redirect(send_url);
        }

        #region 開、決標、比議價紀錄
        protected void lbtnToWordD18_1_1_Click(object sender, EventArgs e)
        {
            //開、決標、比議價紀錄
            string filepath = OutputWordD18_1_1();
        ...
        protected void lbtnToWordD18_1_1_pdf_Click(object sender, EventArgs e)
        {
            string filepath = OutputWordD18_1_1();
            string filetemp = Request.PhysicalApplicationPath + "WordPDFprint/WordD18_1_1_pdf.pdf";
            string FileName = strOVC_PURCH + "-開、決標、比議價紀錄.pdf";
            FCommon.WordToPDF(this, filepath, filetemp, FileName);
        }
        protected void lbtnToWordD18_1_1_odt_Click(object sender, EventArgs e)
        {
            string filepath = OutputWordD18_1_1();
            string filetemp = Request.PhysicalApplicationPath + "WordPDFprint/WordD18_1_1_odt.odt";
            string FileName = strOVC_PURCH + "-開、決標、比議價紀錄.odt";
            FCommon.WordToOdt(this, filepath, filetemp, FileName);
        }
        #endregion

        #region 廠商減價單(分組)
        protected void lbtnToWordD18_1_2_Click(object sender, EventArgs e)
        {
            //廠商減價單(分組)
            string filepath = OutputWordD18_1_2();
        ...
        protected void lbtnToWordD18_1_2_pdf_Click(object sender, EventArgs e)
        {
            string filepath = OutputWordD18_1_2();
            string filetemp = Request.PhysicalApplicationPath + "WordPDFprint/WordD18_1_2_pdf.pdf";
            string FileName = strOVC_PURCH + "-廠商減價單(分組).pdf";
            FCommon.WordToPDF(this, filepath, filetemp, FileName);
        }
        protected void lbtnToWordD18_1_2_odt_Click(object sender, EventArgs e)
        {
            string filepath = OutputWordD18_1_2();
            string filetemp = Request.PhysicalApplicationPath + "WordPDFprint/WordD18_1_2_odt.odt";
            string FileName = strOVC_PURCH + "-廠商減價單(分組).odt";
            FCommon.WordToOdt(this, filepath, filetemp, FileName);
        }
        #endregion

        #region 廠商減價單(折扣)
        protected void lbtnToWordD18_1_3_Click(object sender, EventArgs e)
        {
            //廠商減價單(折扣)
            string filepath = OutputWordD18_1_3();
        ...
        protected void lbtnToWordD18_1_3_pdf_Click(object sender, EventArgs e)
        {
            string filepath = OutputWordD18_1_3();
            string filetemp = Request.PhysicalApplicationPath + "WordPDFprint/WordD18_1_3_pdf.pdf";
            string FileName = strOVC_PURCH + "-廠商減價單(折扣).pdf";
            FCommon.WordToPDF(this, filepath, filetemp, FileName);
        }
        protected void lbtnToWordD18_1_3_odt_Click(object sender, EventArgs e)
        {
            string filepath = OutputWordD18_1_3();
            string filetemp = Request.PhysicalApplicationPath + "WordPDFprint/WordD18_1_3_odt.odt";
            string FileName = strOVC_PURCH + "-廠商減價單(折扣).odt";
            FCommon.WordToOdt(this, filepath, filetemp, FileName);
        }
        #endregion

        #region 廠商減價單(總價)
        protected void lbtnToWordD18_1_4_Click(object sender, EventArgs e)
        {
            //廠商減價單(總價)
            string filepath = OutputWordD18_1_4();
        ...
        protected void lbtnToWordD18_1_4_pdf_Click(object sender, EventArgs e)
        {
            string filepath = OutputWordD18_1_4();
            string filetemp = Request.PhysicalApplicationPath + "WordPDFprint/WordD18_1_4_pdf.pdf";
            string FileName = strOVC_PURCH + "-廠商減價單(總價).pdf";
            FCommon.WordToPDF(this, filepath, filetemp, FileName);
        }
        protected void lbtnToWordD18_1_4_odt_Click(object sender, EventArgs e)
        {
            string filepath = OutputWordD18_1_4();
            string filetemp = Request.PhysicalApplicationPath + "WordPDFprint/WordD18_1_4_odt.odt";
            string FileName = strOVC_PURCH + "-廠商減價單(總價).odt";
            FCommon.WordToOdt(this, filepath, filetemp, FileName);
        }
        #endregion

        #region 減價單(單價)
        protected void lbtnToWordD18_1_5_Click(object sender, EventArgs e)
        {
            //減價單(單價)
            string filepath = OutputWordD18_1_5();
        ...
        protected void lbtnToWordD18_1_5_pdf_Click(object sender, EventArgs e)
        {
            string filepath = OutputWordD18_1_5();
            string filetemp = Request.PhysicalApplicationPath + "WordPDFprint/WordD18_1_5_pdf.pdf";
            string FileName = strOVC_PURCH + "-減價單(單價).pdf";
            FCommon.WordToPDF(this, filepath, filetemp, FileName);
        }
        protected void lbtnToWordD18_1_5_odt_Click(object sender, EventArgs e)
        {
            string filepath = OutputWordD18_1_5();
            string filetemp = Request.PhysicalApplicationPath + "WordPDFprint/WordD18_1_5_odt.odt";
            string FileName = strOVC_PURCH + "-減價單(單價).odt";
            FCommon.WordToOdt(this, filepath, filetemp, FileName);
        }
        #endregion
        ...
        {
            //點擊 押標金投標文件退還作業
            string send_url = "~/pages/MPMS/D/MPMS_D18_6.aspx?OVC_PURCH=" + strOVC_PURCH + "&OVC_DOPEN=" + strOVC_DOPEN
                            + "&ONB_TIMES=" + numONB_TIMES + "&ONB_GROUP=" + numONB_GROUP;
            Response.Redirect(send_url);
        }
        ...
        {
            //點擊 開標紀錄分送作業
            string send_url = "~/pages/MPMS/D/MPMS_D18_5.aspx?OVC_PURCH=" + strOVC_PURCH + "&OVC_DOPEN=" + strOVC_DOPEN
                                + "&ONB_TIMES=" + numONB_TIMES + "&ONB_GROUP=" + numONB_GROUP;
            Response.Redirect(send_url);
        }
        ...
        {
            //主標人
            var tbmRECEIVE_WORK = mpms.TBMRECEIVE_WORK.Where(tb => tb.OVC_PURCH.Equals(strOVC_PURCH)
            ...
            {
                txtOVC_CHAIRMAN.Text = tbmRECEIVE_WORK.OVC_CHAIRMAN;
            }
            ...
            if (tbm1301 != null)
            {
                ...
                if (tbmRECEIVE_ANNOUNCE != null)
                {
                    ...
                    lblOVC_DANNOUNCE.Text = tbmRECEIVE_ANNOUNCE.OVC_DANNOUNCE == null ? "" : GetTaiwanDate(tbmRECEIVE_ANNOUNCE.OVC_DANNOUNCE);
                }
        ...
        private string OutputWordD18_1_1()
        {
            //開、決標、比議價紀錄.docx
            var targetPath = Server.MapPath("~/WordPDFprint/");
            string fileName = strOVC_PURCH + "-開、決標、比議價紀錄.docx";
            File.Copy(targetPath + "D18_1_1-開、決標、比議價紀錄.docx", targetPath + fileName);
            ...
            if (tbm1301 != null)
            {
                ...
                */
                ...
                var tableContent2 = new TableContent("row2");
                var tableContent3 = new TableContent("row3");
                if (dt.Rows.Count != 0)
                {
                    string strOVC_VEN_TITLE, strONB_MBID, strONB_MINIS_LOWEST, strONB_MINIS_1, strONB_MINIS_2, strONB_MINIS_3, strONB_MINIS_4, strONB_MINIS_5,
                        strONB_MINIS_6, strONB_MINIS_7, strONB_MINIS_8, strONB_MINIS_9, strONB_MINIS_10, strONB_MINIS_11, strONB_MINIS_12;
                    foreach (DataRow rows in dt.Rows)
                    {
                        ...
                        strONB_MINIS_4 = rows["ONB_MINIS_4"] == null ? "" : rows["ONB_MINIS_4"].ToString();
                        strONB_MINIS_5 = rows["ONB_MINIS_5"] == null ? "" : rows["ONB_MINIS_5"].ToString();
                        strONB_MINIS_6 = rows["ONB_MINIS_6"] == null ? "" : rows["ONB_MINIS_6"].ToString();
                        strONB_MINIS_7 = rows["ONB_MINIS_7"] == null ? "" : rows["ONB_MINIS_7"].ToString();
                        strONB_MINIS_8 = rows["ONB_MINIS_8"] == null ? "" : rows["ONB_MINIS_8"].ToString();
                        strONB_MINIS_9 = rows["ONB_MINIS_9"] == null ? "" : rows["ONB_MINIS_9"].ToString();
                        strONB_MINIS_10 = rows["ONB_MINIS_10"] == null ? "" : rows["ONB_MINIS_10"].ToString();
                        strONB_MINIS_11 = rows["ONB_MINIS_11"] == null ? "" : rows["ONB_MINIS_11"].ToString();
                        strONB_MINIS_12 = rows["ONB_MINIS_12"] == null ? "" : rows["ONB_MINIS_12"].ToString();
                        ...
                        tableContent2.AddRow(
                            new FieldContent("OVC_VEN_TITLE", strOVC_VEN_TITLE),
                            new FieldContent("ONB_MINIS_4", strONB_MINIS_4),
                            new FieldContent("ONB_MINIS_5", strONB_MINIS_5),
                            new FieldContent("ONB_MINIS_6", strONB_MINIS_6),
                            new FieldContent("ONB_MINIS_7", strONB_MINIS_7),
                            new FieldContent("ONB_MINIS_8", strONB_MINIS_8)
                        );
                        tableContent3.AddRow(
                            new FieldContent("OVC_VEN_TITLE", strOVC_VEN_TITLE),
                            new FieldContent("ONB_MINIS_9", strONB_MINIS_9),
                            new FieldContent("ONB_MINIS_10", strONB_MINIS_10),
                            new FieldContent("ONB_MINIS_11", strONB_MINIS_11),
                            new FieldContent("ONB_MINIS_12", strONB_MINIS_12)
                        );
                    }
                }
                else
                {
                    ...
                    tableContent2.AddRow(
                        new FieldContent("OVC_VEN_TITLE", ""),
                        new FieldContent("ONB_MINIS_4", ""),
                        new FieldContent("ONB_MINIS_5", ""),
                        new FieldContent("ONB_MINIS_6", ""),
                        new FieldContent("ONB_MINIS_7", ""),
                        new FieldContent("ONB_MINIS_8", "")
                    );
                    tableContent3.AddRow(
                        new FieldContent("OVC_VEN_TITLE", ""),
                        new FieldContent("ONB_MINIS_9", ""),
                        new FieldContent("ONB_MINIS_10", ""),
                        new FieldContent("ONB_MINIS_11", ""),
                        new FieldContent("ONB_MINIS_12", "")
                    );
                }
            ...
            //        {
            //            var rowPattern = groceryListTable.Rows[3];
            //            var rowPattern_2 = groceryListTable.Rows[4];
            //            var newItem = groceryListTable.InsertRow(rowPattern, groceryListTable.RowCount - 8);
            //        }
            //        doc.SaveAs(filepath);
            //    }
            //}
        ...
        private string OutputWordD18_1_2()
        {
            //廠商減價單(分組)
            var targetPath = Server.MapPath("~/WordPDFprint/");
            string fileName = strOVC_PURCH + "-廠商減價單(分組).docx";
            File.Copy(targetPath + "D18_1_2-廠商減價單(分組).docx", targetPath + fileName);
        ...
        private string OutputWordD18_1_3()
        {
            //廠商減價單(折扣)
            var targetPath = Server.MapPath("~/WordPDFprint/");
            string fileName = strOVC_PURCH + "-廠商減價單(折扣).docx";
            File.Copy(targetPath + "D18_1_3-廠商減價單(折扣).docx", targetPath + fileName);
            var valuesToFill = new TemplateEngine.Docx.Content();
        ...
        private string OutputWordD18_1_4()
        {
            var targetPath = Server.MapPath("~/WordPDFprint/");
            string fileName = strOVC_PURCH + "-廠商減價單(總價).docx";
            File.Copy(targetPath + "D18_1_4-廠商減價單(總價).docx", targetPath + fileName);
            var valuesToFill = new TemplateEngine.Docx.Content();
        ...
        private string OutputWordD18_1_5()
        {
            var targetPath = Server.MapPath("~/WordPDFprint/");
            string fileName = strOVC_PURCH + "-減價單(單價).docx";
            File.Copy(targetPath + "D18_1_5-減價單(單價).docx", targetPath + fileName);
