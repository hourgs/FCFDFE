...
{
    public partial class MPMS_D19_3 : System.Web.UI.Page
    {
        ...
        {
            //點擊 回開標紀錄選擇畫面
            string send_url = "~/pages/MPMS/D/MPMS_D19.aspx?OVC_PURCH=" + strOVC_PURCH;
            Response.Redirect(send_url);
        }
        ...
        protected void lbtnToWordD19_3_Click(object sender, EventArgs e)
        {
            //點擊 紀錄發送清冊
            ...
            if (tbm1301 != null)
            {
                ...
                string fileName = "D19_3-紀錄發送清冊.docx";
