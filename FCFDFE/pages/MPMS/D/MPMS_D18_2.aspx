<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MPMS_D18_2.aspx.cs" Inherits="FCFDFE.pages.MPMS.D.MPMS_D18_2" %>
                ...
                <div class="panel-body" style="border: solid 2px;">
                    <div class="form" style="border: 5px;">
                        ...
                        <div class="text-center" style="margin-bottom: 10px;">
                            <asp:Button ID="btnCopy" Text="複製審查資料" OnClick="btnCopy_Click" CssClass="btn-warning btnw6" runat="server" />
                        </div>
                        ...
                        <div class="text-center">
                            <asp:Button ID="btnSave" Text="存檔" OnClick="btnSave_Click" CssClass="btn-warning btnw2" runat="server" />
                            <asp:Button ID="btnSave_OK" OnClick="btnSave_OK_Click" Style="display:none" runat="server" />
                            <asp:Button ID="btnReturn" Text="回截標審查作業畫面" CssClass="btn-warning " runat="server" />
                            <asp:Button ID="btnReturnM" Text="回主流程畫面" CssClass="btn-warning btnw6" runat="server" />
