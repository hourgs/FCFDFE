<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MPMS_D1B.aspx.cs" Inherits="FCFDFE.pages.MPMS.D.MPMS_D1B" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <script>
        function OpenD1B1() {
            ...
            var theURL = '<%=ResolveClientUrl("MPMS_D1B_1.aspx?OVC_PURCH=")%>' + OVC_PURCH + '&OVC_PURCH_5=' + OVC_PURCH_5;
                    ...
                    <div class="panel-body"style="border: solid 2px;" >
                        <div class="form" style="border: 5px;">
                            <div class="cmxform form-horizontal tasi-form">
                                <!--網頁內容-->
                                <asp:GridView ID="GV_TBM1303" CssClass="table table-striped border-top text-center" DataKeyNames="ONB_GROUP" OnPreRender="GV_TBM1303_PreRender" OnRowCommand="GV_TBM1303_RowCommand" AutoGenerateColumns="false" runat="server">
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="作業">
                                            <ItemTemplate>
                                                <asp:Button CssClass="btn-default" ID="btnWork" Text="作業" CommandName="btnwork" runat="server" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="開標次數(組別)">
                                            <ItemTemplate>
                                                <asp:Label ID="lblONB_TIMES" CssClass="control-label" Text='<%# Eval("ONB_TIMES") %>' runat="server"></asp:Label>
                                                <asp:Label CssClass="control-label" Text='(' runat="server"></asp:Label>
                                                <asp:Label ID="lblONB_GROUP" CssClass="control-label" Text='<%# Eval("ONB_GROUP") %>' runat="server"></asp:Label>
                                                <asp:Label CssClass="control-label" Text=')' runat="server"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="開標時間">
                                            <ItemTemplate>
                                                <asp:Label ID="lblOVC_DOPEN" CssClass="control-label" Text='<%# Eval("OVC_DOPEN") %>' Visible="false" runat="server"></asp:Label>
                                                <asp:Label ID="lblOVC_DOPEN_tw" CssClass="control-label" Text='<%# Eval("OVC_DOPEN_tw") %>' runat="server"></asp:Label>
                                                <asp:Label ID="lblOVC_OPEN_HOUR" CssClass="control-label" Text='<%# Eval("OVC_OPEN_HOUR") %>' runat="server"></asp:Label>
                                                <asp:Label CssClass="control-label" runat="server">時</asp:Label>
                                                <asp:Label ID="lblOVC_OPEN_MIN" CssClass="control-label" Text='<%# Eval("OVC_OPEN_MIN") %>' runat="server"></asp:Label>
                                        ...
                                        <asp:BoundField HeaderText="主官核批日" DataField="OVC_DAPPROVE" />
                                    </Columns>
                                </asp:GridView>
                                <div style="text-align: center">
                                    <asp:Button CssClass="btn-default" ID="btnBefore" OnClick="btnBefore_Click" Text="回上一頁" runat="server" />
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="panel-body" style="border: solid 2px;">
                        <div class="form" style="border: 5px;">
                            <div class="cmxform form-horizontal tasi-form">
                                ...
                                <div style="text-align: center">
                                    <asp:Button ID="btnToDefault" OnClick="btnToDefault_Click" CssClass="btn-default" runat="server" Text="回上一頁" />
                                    <asp:Button ID="btnSave" OnClick="btnSave_Click" CssClass="btn-default btnw2" runat="server" Text="存檔" />
                                    <asp:Button ID="btnReRead" OnClick="btnReRead_Click" CssClass="btn-default" runat="server" Text="重新讀取開標紀錄說明" />
                                    <asp:LinkButton ID="lbtnToWord_D1B" OnClick="lbtnToWord_D1B_Click" runat="server">開標結果報告表預覽列印</asp:LinkButton><br/><br/>
