<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MPMS_D18_1.aspx.cs" Inherits="FCFDFE.pages.MPMS.D.MPMS_D18_1" %>
                    ...
                    <div class="form" style="border: 5px;">
                                            ...
                                            <ContentTemplate>
                                                ...
                                                <asp:GridView ID="gvTBM1314" OnRowCommand="gvTBM1314_RowCommand" CssClass="table data-table table-striped border-top text-center" AutoGenerateColumns="false" runat="server">
 		     		                                <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="更多" ItemStyle-CssClass="text-center">
                                                            <ItemTemplate>
                                                                <asp:Label Text ="..." CssClass="control-label" runat="server"></asp:Label>
                                                                <asp:Button Visible="false" ID="btnMore" CommandName="More" CssClass="btn-default btnw2" Text="..." runat="server" />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                    </Columns>
	   		                                    </asp:GridView>
                                                ...
                                                <table class="table table-bordered text-center">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:Label Text="組別：" CssClass="control-label" runat="server"></asp:Label><br />
                                                            <asp:TextBox ID="txtONB_GROUP_TBM1314" CssClass="tb tb-s" runat="server"></asp:TextBox><br /><br /><br /><br /><br /><br />
                                                            <asp:Label Text="廠商名稱：" CssClass="control-label" runat="server"></asp:Label><br />
                                                        ...
                                                        <td class="text-left">
                                                            ...
                                                            <asp:Label CssClass="control-label text-red" runat="server">金額或折扣率</asp:Label><br>
                                                            <asp:TextBox ID="txtONB_MINIS_4" CssClass="tb tb-s" OnKeyPress="if(((event.keyCode>=48)&&(event.keyCode <=57))||(event.keyCode==46)) {event.returnValue=true;} else{event.returnValue=false;}" runat="server"></asp:TextBox><br><br>
                                                            <asp:Label CssClass="control-label" runat="server" >標價區分(擇一)</asp:Label><br>
                                                    ...
                                                    <tr>
                                                        <td class="text-left">
                                                            ...
                                                            <asp:Label CssClass="control-label text-red" runat="server">金額或折扣率</asp:Label><br>
                                                            <asp:TextBox ID="txtONB_MINIS_5" CssClass="tb tb-s" OnKeyPress="if(((event.keyCode>=48)&&(event.keyCode <=57))||(event.keyCode==46)) {event.returnValue=true;} else{event.returnValue=false;}" runat="server"></asp:TextBox><br><br>
                                                            <asp:Label CssClass="control-label" runat="server" >標價區分(擇一)</asp:Label><br>
                                                        ...
                                                        <td class="text-left">
                                                            ...
                                                            <asp:Label CssClass="control-label text-red" runat="server">金額或折扣率</asp:Label><br>
                                                            <asp:TextBox ID="txtONB_MINIS_6" CssClass="tb tb-s" OnKeyPress="if(((event.keyCode>=48)&&(event.keyCode <=57))||(event.keyCode==46)) {event.returnValue=true;} else{event.returnValue=false;}" runat="server"></asp:TextBox><br><br>
                                                            <asp:Label CssClass="control-label" runat="server" >標價區分(擇一)</asp:Label><br>
                                                        ...
                                                        <td class="text-left">
                                                            ...
                                                            <asp:Label CssClass="control-label text-red" runat="server">金額或折扣率</asp:Label><br>
                                                            <asp:TextBox ID="txtONB_MINIS_7" CssClass="tb tb-s" OnKeyPress="if(((event.keyCode>=48)&&(event.keyCode <=57))||(event.keyCode==46)) {event.returnValue=true;} else{event.returnValue=false;}" runat="server"></asp:TextBox><br><br>
                                                            <asp:Label CssClass="control-label" runat="server" >標價區分(擇一)</asp:Label><br>
                                                        ...
                                                        <td class="text-left">
                                                            ...
                                                            <asp:Label CssClass="control-label text-red" runat="server">金額或折扣率</asp:Label><br>
                                                            <asp:TextBox ID="txtONB_MINIS_8" CssClass="tb tb-s" OnKeyPress="if(((event.keyCode>=48)&&(event.keyCode <=57))||(event.keyCode==46)) {event.returnValue=true;} else{event.returnValue=false;}" runat="server"></asp:TextBox><br><br>
                                                            <asp:Label CssClass="control-label" runat="server" >標價區分(擇一)</asp:Label><br>
                                                        ...
                                                        <td class="text-left">
                                                            ...
                                                            <asp:Label CssClass="control-label text-red" runat="server">金額或折扣率</asp:Label><br>
                                                            <asp:TextBox ID="txtONB_MINIS_9" CssClass="tb tb-s" OnKeyPress="if(((event.keyCode>=48)&&(event.keyCode <=57))||(event.keyCode==46)) {event.returnValue=true;} else{event.returnValue=false;}" runat="server"></asp:TextBox><br><br>
                                                            <asp:Label CssClass="control-label" runat="server" >標價區分(擇一)</asp:Label><br>
                                                        ...
                                                        <td class="text-left">
                                                            ...
                                                            <asp:Label CssClass="control-label text-red" runat="server">金額或折扣率</asp:Label><br>
                                                            <asp:TextBox ID="txtONB_MINIS_10" CssClass="tb tb-s" OnKeyPress="if(((event.keyCode>=48)&&(event.keyCode <=57))||(event.keyCode==46)) {event.returnValue=true;} else{event.returnValue=false;}" runat="server"></asp:TextBox><br><br>
                                                            <asp:Label CssClass="control-label" runat="server" >標價區分(擇一)</asp:Label><br>
                                                        ...
                                                        <td class="text-left">
                                                            ...
                                                            <asp:Label CssClass="control-label text-red" runat="server">金額或折扣率</asp:Label><br>
                                                            <asp:TextBox ID="txtONB_MINIS_11" CssClass="tb tb-s" OnKeyPress="if(((event.keyCode>=48)&&(event.keyCode <=57))||(event.keyCode==46)) {event.returnValue=true;} else{event.returnValue=false;}" runat="server"></asp:TextBox><br><br>
                                                            <asp:Label CssClass="control-label" runat="server" >標價區分(擇一)</asp:Label><br>
                                                        ...
                                                        <td class="text-left">
                                                            ...
                                                            <asp:Label CssClass="control-label text-red" runat="server">金額或折扣率</asp:Label><br>
                                                            <asp:TextBox ID="txtONB_MINIS_12" CssClass="tb tb-s" OnKeyPress="if(((event.keyCode>=48)&&(event.keyCode <=57))||(event.keyCode==46)) {event.returnValue=true;} else{event.returnValue=false;}" runat="server"></asp:TextBox><br><br>
                                                            <asp:Label CssClass="control-label" runat="server" >標價區分(擇一)</asp:Label><br>
                        ...
                        <div>
                            ...
                            <div class="text-center diva">
                                <asp:LinkButton id="lbtnToWordD18_1_1_old" Visible="false" OnClick="lbtnToWordD18_1_1_Click" CssClass="btn-default" runat="server">開、決標、比議價紀錄</asp:LinkButton>
                                <asp:LinkButton id="lbtnToWordD18_1_2_old" Visible="false" OnClick="lbtnToWordD18_1_2_Click" CssClass="btn-default" runat="server">廠商減價單(分組)</asp:LinkButton>
                                <asp:LinkButton id="lbtnToWordD18_1_3_old" Visible="false" OnClick="lbtnToWordD18_1_3_Click" CssClass="btn-default" runat="server">廠商減價單(折扣)</asp:LinkButton>
                                <asp:LinkButton id="lbtnToWordD18_1_4_old" Visible="false" OnClick="lbtnToWordD18_1_4_Click" CssClass="btn-default" runat="server">廠商減價單(總價)</asp:LinkButton>
                                <asp:LinkButton id="lbtnToWordD18_1_5_old" Visible="false" OnClick="lbtnToWordD18_1_5_Click" CssClass="btn-default" runat="server">減價單(單價)</asp:LinkButton>

                                <table>
                                        <tr>
                                            <td style="width:200px"><asp:LinkButton id="lbtnToWordD18_1_1" OnClick="lbtnToWordD18_1_1_Click" runat="server">開、決標、比議價紀錄.doc</asp:LinkButton></td>
                                            <td style="width:150px"><asp:LinkButton id="lbtnToWordD18_1_2" OnClick="lbtnToWordD18_1_2_Click" runat="server">廠商減價單(分組).doc</asp:LinkButton></td>
                                            <td style="width:150px"><asp:LinkButton id="lbtnToWordD18_1_3" OnClick="lbtnToWordD18_1_3_Click" runat="server">廠商減價單(折扣).doc</asp:LinkButton></td>
                                            <td style="width:150px"><asp:LinkButton id="lbtnToWordD18_1_4" OnClick="lbtnToWordD18_1_4_Click" runat="server">廠商減價單(總價).doc</asp:LinkButton></td>
                                            <td style="width:150px"><asp:LinkButton id="lbtnToWordD18_1_5" OnClick="lbtnToWordD18_1_5_Click" runat="server">減價單(單價).doc</asp:LinkButton></td>
                                        </tr>                       
                                        <%-- <tr>
                                            <td style="width:200px"><asp:LinkButton id="lbtnToWordD18_1_1_pdf" OnClick="lbtnToWordD18_1_1_pdf_Click" runat="server">開、決標、比議價紀錄.pdf</asp:LinkButton></td>
                                            <td style="width:150px"><asp:LinkButton id="lbtnToWordD18_1_2_pdf" OnClick="lbtnToWordD18_1_2_pdf_Click" runat="server">廠商減價單(分組).pdf</asp:LinkButton></td>
                                            <td style="width:150px"><asp:LinkButton id="lbtnToWordD18_1_3_pdf" OnClick="lbtnToWordD18_1_3_pdf_Click" runat="server">廠商減價單(折扣).pdf</asp:LinkButton></td>
                                            <td style="width:150px"><asp:LinkButton id="lbtnToWordD18_1_4_pdf" OnClick="lbtnToWordD18_1_4_pdf_Click" runat="server">廠商減價單(總價).pdf</asp:LinkButton></td>
                                            <td style="width:150px"><asp:LinkButton id="lbtnToWordD18_1_5_pdf" OnClick="lbtnToWordD18_1_5_pdf_Click" runat="server">減價單(單價).pdf</asp:LinkButton></td>
                                        </tr>--%>
                                        <tr>
                                            <td style="width:200px"><asp:LinkButton id="lbtnToWordD18_1_1_odt" OnClick="lbtnToWordD18_1_1_odt_Click" runat="server">開、決標、比議價紀錄.odt</asp:LinkButton></td>
                                            <td style="width:150px"><asp:LinkButton id="lbtnToWordD18_1_2_odt" OnClick="lbtnToWordD18_1_2_odt_Click" runat="server">廠商減價單(分組).odt</asp:LinkButton></td>
                                            <td style="width:150px"><asp:LinkButton id="lbtnToWordD18_1_3_odt" OnClick="lbtnToWordD18_1_3_odt_Click" runat="server">廠商減價單(折扣).odt</asp:LinkButton></td>
                                            <td style="width:150px"><asp:LinkButton id="lbtnToWordD18_1_4_odt" OnClick="lbtnToWordD18_1_4_odt_Click" runat="server">廠商減價單(總價).odt</asp:LinkButton></td>
                                            <td style="width:150px"><asp:LinkButton id="lbtnToWordD18_1_5_odt" OnClick="lbtnToWordD18_1_5_odt_Click" runat="server">減價單(單價).odt</asp:LinkButton></td>
                                        </tr>
                                    </table>
                            </div>
                        </div>
