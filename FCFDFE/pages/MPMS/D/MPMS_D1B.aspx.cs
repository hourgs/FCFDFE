...
{
    public partial class MPMS_D1B : System.Web.UI.Page
    {
        Common FCommon = new Common();
        GMEntities gm = new GMEntities();
        MPMSEntities mpms = new MPMSEntities();
        public string sOVC_PURCH, sOVC_PURCH_5, sONB_GROUP;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (FCommon.getAuth(this))
            {
                ...
                {
                    string strOVC_PURCH_5 = Request.QueryString["OVC_PURCH_5"] == null ? "" : Request.QueryString["OVC_PURCH_5"].ToString();
                    string strOVC_DOPEN = "";
                    ...
                    if (IsOVC_DO_NAME() && !IsPostBack)
                    {
                        ...
                        if (Request.QueryString["ONB_GROUP"] != null)
                        {
                            string strONB_GROUP = Request.QueryString["ONB_GROUP"];
                            string strOVC_DOPEN_url = Request.QueryString["OVC_DOPEN"] == null? "" : Request.QueryString["OVC_DOPEN"].ToString();
                            Panel1.Visible = false;
                            Panel2.Visible = true;
                            strOVC_DOPEN = ViewState["OVC_DOPEN"] == null ? strOVC_DOPEN_url : ViewState["OVC_DOPEN"].ToString();
                            dataImportEdit(strONB_GROUP, strOVC_DOPEN);
                            fotterdata(strONB_GROUP);
                            ViewState["group"] = strONB_GROUP;
                        }
        ...
        private void dataImport(string strOVC_PURCH, string strOVC_PURCH_5)
        {
            ...
            var query = from tbm1303 in mpms.TBM1303
                        where tbm1303.OVC_PURCH == strOVC_PURCH
                        where tbm1303.OVC_PURCH_5 == strOVC_PURCH_5
                        join tbm1407 in mpms.TBM1407 on tbm1303.OVC_RESULT equals tbm1407.OVC_PHR_ID
                        where tbm1407.OVC_PHR_CATE == "A8"
                        join tbm1301 in mpms.TBM1301 on tbm1303.OVC_PURCH equals tbm1301.OVC_PURCH
                        select new
                        {
                            ...
                            OVC_OPEN_HOUR = tbm1303.OVC_OPEN_HOUR,
                            OVC_OPEN_MIN = tbm1303.OVC_OPEN_MIN,
                            OVC_CHAIRMAN = tbm1303.OVC_CHAIRMAN,
                            OVC_RESULT = tbm1407.OVC_PHR_DESC,
            ...
            if (dt.Rows.Count != 0)
            {
                ...
                {
                    rows["OVC_DOPEN_tw"] = GetTaiwanDate(rows["OVC_DOPEN"].ToString());
                    rows["OVC_DAPPROVE"] = GetTaiwanDate(rows["OVC_DAPPROVE"].ToString());
                }
            }
            ViewState["Status"] = FCommon.GridView_dataImport(GV_TBM1303, dt);
        }

        private void dataImportEdit(string strONB_GROUP, string strOVC_DOPEN)
        {
            ...
            if (query1303 != null)
            {
                ...
                lblONB_TIMES.Text = query1303.ONB_TIMES.ToString();
            ...
            /*      
            // ------ TBM1313.OVC_RESULT  改成  TBM1303.OVC_RESULT
            var query1313 =
                (from tbm1313 in mpms.TBM1313
                 where tbm1313.OVC_PURCH == strOVC_PURCH
                 where tbm1313.OVC_PURCH_5 == strOVC_PURCH_5
            ...
            if (query1313 != null)
            {
                ...
                if (query1313.OVC_RESULT == "0" || query1313.OVC_RESULT == "3")//決標日顯示條件
                {
                    PanelDBID.Visible = true;
                    lblOVC_DBID.Text = queryRESULT == null ? "" : queryRESULT.OVC_DBID;
                }
        ...
        protected void GV_TBM1303_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            switch (e.CommandName)
            {
                case "btnwork":
                    Panel1.Visible = false;
                    Panel2.Visible = true;
                    string strOVC_DOPEN = ((Label)GV_TBM1303.Rows[gvrIndex].FindControl("lblOVC_DOPEN")).Text;
                    dataImportEdit(id, strOVC_DOPEN);
                    fotterdata(id);
                    ViewState["group"] = id;
        ...
        {
            //點擊 回上一頁
            string send_url = "~/pages/MPMS/D/MPMS_D14_1.aspx?OVC_PURCH=" + ViewState["strOVC_PURCH"].ToString();
        ...
        protected void btnOVC_RESULT_REASON_Click(object sender, EventArgs e)
        {
            ...
            string send_url = "MPMS_D32.aspx?OVC_PURCH=" + key + "&OVC_PURCH_5=" + key2 + "&ONB_GROUP=" + key3+"&TYPE="+key4;
        ...
        protected void btnTBMRESULT_ANNOUNCE_NONE_Click(object sender, EventArgs e)
        {
            ...
            string send_url = "MPMS_D34.aspx?OVC_PURCH=" + key + "&OVC_PURCH_5=" + key2;
        ...
        {
            string id = ViewState["group"].ToString();
            dataImportEdit(id, ViewState["OVC_DOPEN"].ToString());
        }
        ...
        private void OutputWord_D1B()
        {
            short numONB_GROUP = short.Parse(lblONB_GROUP.Text);
