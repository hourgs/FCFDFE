<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MPMS_C18_3.aspx.cs" Inherits="FCFDFE.pages.MPMS.C.MPMS_C18_3" %>
                           ...
                           <asp:Panel ID="pn_Button" HorizontalAlign="Center" runat="server"></asp:Panel>
                            ...
                            <div class="text-center">
                                ...
                                <table class="table table-bordered text-center">
                                    <tr>
                                        <td>
                                            <asp:Button ID="btn_EditSave" CssClass="btn-success btnw2" Text="存檔" runat="server" /></td>
                                        <td>
