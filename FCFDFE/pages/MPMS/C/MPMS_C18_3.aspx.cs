...
{
    public partial class MPMS_C18_3 : System.Web.UI.Page
    {
        ...
        protected void GV_EDITMEMO_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            else if (e.CommandName.Equals("btnDel"))
            {
                ...
                TBM1202_6 tbm1202_6 = new TBM1202_6();
                tbm1202_6 =
                    mpms.TBM1202_6.Where(o => o.OVC_PURCH.Equals(strPurchNum)
                                         && o.ONB_CHECK_TIMES == ONB_CHECK_TIMES
                                         && o.OVC_CHECK_UNIT == detp
                                         && o.ONB_NO== number)
                                  .FirstOrDefault();
                mpms.Entry(tbm1202_6).State = EntityState.Deleted;
                mpms.SaveChanges();
                FCommon.syslog_add(Session["userid"].ToString(), Request.ServerVariables["REMOTE_ADDR"].ToString()
                           , tbm1202_6.GetType().Name.ToString(), this, "刪除");
                MemoMainImport();
            }
        }
        ...
        protected void GV_OVC_MEMO_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            {
                SaveMemo(txtOVC_MEMO.Text, "ss", "Y");
            }
        }
        ...
        private void EditMemo()
        {
            if (ViewState["BtnId"] != null)
            {
                ...
                if (ViewState["ONBNO"] == null)
                {
                    //null表示沒資料要新增
                    TBM1202_6 tbm1202_6 = new TBM1202_6();
                    tbm1202_6.OVC_PURCH = strPurchNum;
                    tbm1202_6.ONB_CHECK_TIMES = (byte)ONB_CHECK_TIMES;
                    tbm1202_6.OVC_CHECK_UNIT = detp;
                    tbm1202_6.OVC_IKIND = ikind;
                    tbm1202_6.ONB_NO = 1;
                    tbm1202_6.OVC_MEMO = txtNewOVC_MEMO.Text;
                    tbm1202_6.OVC_CHECK = "ss";
                    tbm1202_6.OVC_STANDARD = "N";
                    mpms.TBM1202_6.Add(tbm1202_6);
                    mpms.SaveChanges();
                    FCommon.syslog_add(Session["userid"].ToString(), Request.ServerVariables["REMOTE_ADDR"].ToString()
                           , tbm1202_6.GetType().Name.ToString(), this, "新增");
                    FCommon.AlertShow(PnMessage, "success", "系統訊息", "新增成功");
                }
                else
                {
                    short index = short.Parse(ViewState["ONBNO"].ToString());
                    TBM1202_6 table1202_6 = mpms.TBM1202_6.Where(o => o.OVC_PURCH.Equals(strPurchNum)
                                                                       && o.OVC_IKIND.Equals(strOVC_IKIND)
                                                                       && o.OVC_CHECK_UNIT.Equals(detp)
                                                                       && o.ONB_NO == index)
                                                          .FirstOrDefault();
                    table1202_6.OVC_CHECK = "ss";
                    table1202_6.OVC_MEMO = txtNewOVC_MEMO.Text;
                    table1202_6.OVC_STANDARD = "N";
                    mpms.SaveChanges();
                    FCommon.syslog_add(Session["userid"].ToString(), Request.ServerVariables["REMOTE_ADDR"].ToString()
                           , table1202_6.GetType().Name.ToString(), this, "修改");
        ...
        private void SaveMemo(string memo, string strCheck, string standard)
        {
            ...
            tbm1202_6.OVC_CHECK_UNIT = detp;
            tbm1202_6.OVC_IKIND = ikind;
            tbm1202_6.ONB_NO = (byte)count;
            tbm1202_6.OVC_MEMO = memo;
            tbm1202_6.OVC_CHECK = strCheck;
            tbm1202_6.OVC_STANDARD = standard;
            mpms.TBM1202_6.Add(tbm1202_6);
            mpms.SaveChanges();
            FCommon.syslog_add(Session["userid"].ToString(), Request.ServerVariables["REMOTE_ADDR"].ToString()
                           , tbm1202_6.GetType().Name.ToString(), this, "新增");
