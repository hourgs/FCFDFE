<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FAfterClosedComparisonT.aspx.cs" Inherits="FCFDFE.pages.MPMS.F.FAfterClosedComparisonT" %>
    ...
    <div class="row">
        <div style="width: 95%; margin: auto;">
            <section class="panel">
                ...
                <table id="table1301_History" class="table" runat="server">
                    <tr>
                    ...
                    <tr>
                        <td>
                            <asp:GridView ID="GV_1301_History" CssClass="table table-striped border-top text-center" AutoGenerateColumns="false" runat="server">
                                <Columns>
