...
{
    public partial class FAfterClosedComparisonT : Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                if (!string.IsNullOrEmpty(Request.QueryString["PurNum"]))
                {
                    strPurNum = FCommon.getDecryption(Request.QueryString["PurNum"]);
        ...
        private void Import_table1301()
        {
            ...
            if (query1301 != null && query1301 != null)
            {
            ...
            else if(query1301 == null)
                FCommon.AlertShow(PnMessage, "danger", "系統訊息", "無此購案編號，請重新查詢！");
            FCommon.GridView_dataImport(GV_1301_History, dtCompare);
        ...
        {
            var queryKind = mpms.TBM1301.Where(o => o.OVC_PURCH.Equals(strPurNum)).Select(o => o.OVC_PUR_AGENCY).FirstOrDefault();
            string ovcIkind = "";
            string ovcIkinMark = "";
            switch (queryKind)
            {
