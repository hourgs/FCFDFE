<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MPMS_E1E.aspx.cs" Inherits="FCFDFE.pages.MPMS.E.MPMS_E1E" %>
                            ...
                            <table class="table table-bordered">
                                                ...
                                                <tr class="no-bordered-seesaw">
                                                    <td colspan="4">
                                                        ...
                                                        <asp:TextBox ID="txtOVC_OWNED_NAME" CssClass="tb tb-m" runat="server"></asp:TextBox>
                                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                        <asp:Label CssClass="control-label" runat="server" Text="被保證人統一編號："></asp:Label>
                                                        <asp:TextBox ID="txtOVC_OWNED_NO" CssClass="tb tb-m" runat="server"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr class="no-bordered-seesaw">
                                                    <td colspan="4">
                                                        <asp:Label CssClass="control-label" runat="server" Text="被保證人地址："></asp:Label>
                                                        <asp:TextBox ID="txtOVC_OWNED_ADDRESS" CssClass="tb tb-l" runat="server"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr class="no-bordered-seesaw">
                                                    ...
                                                    <td class="td-inner-table" colspan="4">
                                                        ...
                                                        <table class="table table-inner table-bordered text-center">
                                                            <tr>
                                                                ...
                                                                <td><asp:Label CssClass="control-label text-green" runat="server" Text="保證文件名稱"></asp:Label></td>
                                                                <td><asp:Label CssClass="control-label text-green" runat="server" Text="保證文件份數"></asp:Label></td>
                                                                <td><asp:Label CssClass="control-label text-green" runat="server" Text="入帳金額(必填)"></asp:Label></td>
                                                                <td><asp:Label CssClass="control-label text-green" runat="server" Text="有效日期"></asp:Label></td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td><asp:TextBox ID="txtOVC_NUMBER_1" CssClass="tb tb-xs" runat="server"></asp:TextBox></td>
                                                                <td><asp:TextBox ID="txtONB_MONEY_1" CssClass="tb tb-s" OnTextChanged="txtONB_MONEY_TextChanged" AutoPostBack="true" runat="server"></asp:TextBox></td>
                                                                <td>
                                                                    <div class="input-append datepicker position-left" data-date="<%=DateTime.Now%>" data-date-format="yyyy-mm-dd">
                                                                        <asp:TextBox ID="txtExpDate_1" CssClass="tb tb-s position-left" runat="server"></asp:TextBox>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><asp:TextBox ID="txtOVC_NUMBER_2" CssClass="tb tb-xs" runat="server"></asp:TextBox></td>
                                                                <td><asp:TextBox ID="txtONB_MONEY_2" CssClass="tb tb-s" OnTextChanged="txtONB_MONEY_TextChanged" AutoPostBack="true" runat="server"></asp:TextBox></td>
                                                                <td>
                                                                    <div class="input-append datepicker position-left" data-date="<%=DateTime.Now%>" data-date-format="yyyy-mm-dd">
                                                                        <asp:TextBox ID="txtExpDate_2" CssClass="tb tb-s position-left" runat="server"></asp:TextBox>
                                                                        <div class="add-on"><i class="icon-calendar"></i></div>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td><asp:TextBox ID="txtOVC_NUMBER_3" CssClass="tb tb-xs" runat="server"></asp:TextBox></td>
                                                                <td><asp:TextBox ID="txtONB_MONEY_3" CssClass="tb tb-s" OnTextChanged="txtONB_MONEY_TextChanged" AutoPostBack="true" runat="server"></asp:TextBox></td>
                                                                <td>
                                                                    <div class="input-append datepicker position-left" data-date="<%=DateTime.Now%>" data-date-format="yyyy-mm-dd">
                                                                        <asp:TextBox ID="txtExpDate_3" CssClass="tb tb-s position-left" runat="server"></asp:TextBox>
                                                                        <div class="add-on"><i class="icon-calendar"></i></div>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                        ...
                                                        <asp:Label CssClass="control-label text-red" runat="server" Text="幣別："></asp:Label>
