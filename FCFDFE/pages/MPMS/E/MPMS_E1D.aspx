<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MPMS_E1D.aspx.cs" Inherits="FCFDFE.pages.MPMS.E.MPMS_E1D" %>
                        ...
                        <div class="cmxform form-horizontal tasi-form">
                            ...
                            <table class="table table-bordered">
                                                    ...
                                                    <td class="td-inner-table" colspan="4">
                                                        ...
                                                        <table class="table table-inner table-bordered text-center">
                                                            <tr>
                                                                ...
                                                                <td><asp:Label CssClass="control-label text-green" runat="server" Text="原幣別"></asp:Label></td>
                                                                <td><asp:Label CssClass="control-label text-green" runat="server" Text="原幣金額"></asp:Label></td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><asp:TextBox ID="txtOVC_REASON_1" CssClass="tb tb-l" runat="server"></asp:TextBox></td>
                                                                <td><asp:DropDownList ID="drpOVC_CURRENT_1" CssClass="tb tb-s" runat="server"></asp:DropDownList></td>
                                                                <td><asp:TextBox ID="txtONB_MONEY_1" CssClass="tb tb-s" runat="server"></asp:TextBox></td>
                                                                <td><asp:TextBox ID="txtONB_MONEY_NT_1" CssClass="tb tb-m" OnTextChanged="txtONB_MONEY_NT_TextChanged" AutoPostBack="true" runat="server"></asp:TextBox></td>
                                                            </tr>
                                                            <tr>
                                                                <td><asp:Label ID="lblONB_ITEM_2" CssClass="control-label text-green" runat="server" Text="2"></asp:Label></td>
                                                                <td><asp:TextBox ID="txtOVC_REASON_2" CssClass="tb tb-l" runat="server"></asp:TextBox></td>
                                                                <td><asp:DropDownList ID="drpOVC_CURRENT_2" CssClass="tb tb-s" runat="server"></asp:DropDownList></td>
                                                                <td><asp:TextBox ID="txtONB_MONEY_2" CssClass="tb tb-s" runat="server"></asp:TextBox></td>
                                                                <td><asp:TextBox ID="txtONB_MONEY_NT_2" CssClass="tb tb-m" OnTextChanged="txtONB_MONEY_NT_TextChanged" AutoPostBack="true" runat="server"></asp:TextBox></td>
                                                            </tr>
                                                            <tr>
                                                                <td><asp:Label ID="lblONB_ITEM_3" CssClass="control-label text-green" runat="server" Text="3"></asp:Label></td>
                                                                <td><asp:TextBox ID="txtOVC_REASON_3" CssClass="tb tb-l" runat="server"></asp:TextBox></td>
                                                                <td><asp:DropDownList ID="drpOVC_CURRENT_3" CssClass="tb tb-s" runat="server"></asp:DropDownList></td>
                                                                <td><asp:TextBox ID="txtONB_MONEY_3" CssClass="tb tb-s" runat="server"></asp:TextBox></td>
                                                                <td><asp:TextBox ID="txtONB_MONEY_NT_3" CssClass="tb tb-m" OnTextChanged="txtONB_MONEY_NT_TextChanged" AutoPostBack="true" runat="server"></asp:TextBox></td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr class="no-bordered-seesaw">
                                                    <td colspan="4">
                                                        ...
                                                        <asp:TextBox ID="txtOVC_MARK" CssClass="tb tb-l" runat="server"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr class="no-bordered-seesaw">
                                                    <td colspan="4">
                                                        ...
                                                        <asp:TextBox ID="txtOVC_WORK_NAME" CssClass="tb tb-l" runat="server"></asp:TextBox><br>
                                                    </td>
                                                </tr>
                                                <tr class="no-bordered-seesaw">
                                                    <td colspan="4">
                                                ...
                                                <tr class="no-bordered-seesaw">
                                                    <td colspan="4">
                                                        ...
                                                        <asp:TextBox ID="txtOVC_COMPTROLLER_NO" CssClass="tb tb-m" runat="server"></asp:TextBox>
                                                        <%--<asp:DropDownList ID="drpOVC_COMPTROLLER_NO" CssClass="tb tb-m" runat="server">
                                                ...
                                                <tr class="no-bordered-seesaw">
                                                    <td colspan="4">
                                                        ...
                                                        <asp:TextBox ID="txtOVC_COMPTROLLER_NO_1" CssClass="position-left tb tb-l" runat="server"></asp:TextBox>
                                                        <asp:Label CssClass="control-label position-left" runat="server">日期：</asp:Label>
                                                        <div class="input-append datepicker position-left" data-date="<%=DateTime.Now%>" data-date-format="yyyy-mm-dd">
                            ...
                            <table class="table no-bordered-seesaw text-center">
                                <tr class="no-bordered-seesaw">
                                    ...
                                    <td class="no-bordered"><div class="input-append datepicker position-left" data-date="<%=DateTime.Now%>" data-date-format="yyyy-mm-dd">
                            ...
                            <br />
                            <div class="text-center" id="print" runat="server" visible="false">
                                <asp:LinkButton ID="LinkButton1" OnClick="LinkButton1_Click" CssClass="text-red" runat="server">收入通知單預覽列印.doc</asp:LinkButton>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <asp:LinkButton ID="LinkButton3" OnClick="LinkButton3_Click" CssClass="text-red" runat="server">收入通知單預覽列印.pdf</asp:LinkButton>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <asp:LinkButton ID="LinkButton4" OnClick="LinkButton4_Click" CssClass="text-red" runat="server">收入通知單預覽列印.odt</asp:LinkButton>
                                <asp:HyperLink ID="InkReceivePreview" CssClass="text-red" Visible="false" runat="server">收入通知單預覽列印</asp:HyperLink>
                                <br />
                                <asp:LinkButton ID="LinkButton2" OnClick="LinkButton2_Click" CssClass="text-red" runat="server">退還通知單預覽列印.doc</asp:LinkButton>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <asp:LinkButton ID="LinkButton5" OnClick="LinkButton5_Click" CssClass="text-red" runat="server">退還通知單預覽列印.pdf</asp:LinkButton>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <asp:LinkButton ID="LinkButton6" OnClick="LinkButton6_Click" CssClass="text-red" runat="server">退還通知單預覽列印.odt</asp:LinkButton>
