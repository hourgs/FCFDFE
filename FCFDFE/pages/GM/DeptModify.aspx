<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DeptModify.aspx.cs" Inherits="FCFDFE.pages.GM.DeptModify" %>
                    ...
                    <div class="form" style="border: 5px;">
                        <div class="cmxform form-horizontal tasi-form">
                            <table class="table table-bordered text-center">
                                <tr>
                                    <th colspan="6">
                                        <asp:Label CssClass="th_label" runat="server">全域組織單位－異動</asp:Label>
                                    </th>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <asp:Label ID="lblOVC_DEPT_CDE" CssClass="control-label" runat="server" />
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:DropDownList ID="drpOVC_PURCHASE_OK" CssClass="tb tb-m" runat="server">
                                            <asp:ListItem Value="Y">是：Y</asp:ListItem>
                                            <asp:ListItem Value="N">否：N</asp:ListItem>
                                        </asp:DropDownList>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td colspan="6">
                                        <asp:Button CssClass="btn-success" OnClick="btnModify_Click" runat="server" Text="更新組織單位" />
                                        <asp:Button CssClass="btn-success" OnClick="btnBack_Click" runat="server" Text="回上頁" />
                                    </td>
                                </tr>
                            </table>
                        </div>
