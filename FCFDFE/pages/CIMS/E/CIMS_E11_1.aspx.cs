...
{
    public partial class CIMS_E11_1 : System.Web.UI.Page
    {
        ...
        protected void GVTBGMT_1302_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            switch (e.CommandName)
            {
                case "btnPurch6":
                    ...
                    str_url_Modify = "CIMS_E11_3.aspx?OVC_PURCH=" +pkey + "&OVC_PURCH_6=" + key;
        ...
        protected void GVTBGMT_1201_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            switch (e.CommandName)
            {
                case "btnPoiIcount":
                    string str_url_Modify;
                    str_url_Modify = "CIMS_E11_4.aspx?OVC_PURCH=" + pkey + "&ONB_POI_ICOUNT=" + key;
                    Response.Redirect(str_url_Modify);
                    break;
                default:
                    break;
        ...
        {
            Response.Redirect("CIMS_E11.aspx");
        }
