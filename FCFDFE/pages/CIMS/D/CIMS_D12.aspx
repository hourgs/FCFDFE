<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CIMS_D12.aspx.cs" Inherits="FCFDFE.pages.CIMS.D.CIMS_D12" %>
				...
				<div class="panel-body" style=" border: solid 2px;">
                    <div class="form" style="border: 5px;">
                        <div class="cmxform form-horizontal tasi-form">
                            <!--網頁內容-->
                            <div class="subtitle">物價指數資料上傳</div>
                                ...
                                <tr>
                                    ...
                                    <td class="text-left">
                                        ...
                                        <table class="table table-bordered" style="text-align:center;">
                                            <tr>
                                                <td><asp:Label CssClass="control-label" runat="server">代碼</asp:Label></td>
                                                <td><asp:Label CssClass="control-label" runat="server">週期</asp:Label></td>
                                                <td><asp:Label CssClass="control-label" runat="server">年月</asp:Label></td>
                                                <td><asp:Label CssClass="control-label" runat="server">指數</asp:Label></td>
                                            </tr>
                                        </table>
                                        <asp:Label CssClass="control-label" runat="server">
                                            3.按下[上傳]，即可進行上傳動作
