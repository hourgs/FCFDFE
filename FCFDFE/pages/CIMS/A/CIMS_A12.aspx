<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CIMS_A12.aspx.cs" Inherits="FCFDFE.pages.CIMS.A.CIMS_A12" %>
                            ...
                            <div class="cmxform form-horizontal tasi-form">
                                <asp:GridView ID="GV_VENAGENT" DataKeyNames="REGNO" CssClass="table data-table table-striped border-top table-bordered" OnPreRender="GV_VENAGENT_PreRender" OnRowCommand="GV_VENAGENT_RowCommand" AutoGenerateColumns="false" runat="server">
                                    <Columns>
                                        ...
                                        <asp:BoundField HeaderText="在台效期" DataField="AbleTime" ItemStyle-Width="15%" DataFormatString="{0:d}" />
                    ...
                    <div class="form" style="border: 5px;">
                        <div class="cmxform form-horizontal tasi-form">
                            ...
                            <div class="panel-footer" style="text-align: center;">
                                <!--網頁尾-->
                                <asp:Button ID="btnEdit" CssClass="btn-warning btnw2" runat="server" Text="保存" OnClick="btnEdit_Click" />
                                &emsp;
                    <asp:Button ID="btnDel" CssClass="btn-default btnw2" runat="server" Text="刪除" OnClick="btnDel_Click"/>
                                &emsp;
